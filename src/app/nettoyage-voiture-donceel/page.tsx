...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-donceel",
    },
    openGraph: {
      title: "Nettoyage voiture à domicile à Donceel | Shine&Go (service premium)",
      description: "Lavage voiture Donceel à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-donceel.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Donceel | Shine&Go (service premium)",
      description: "Lavage voiture Donceel à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-donceel.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function DonceelPage() {
  ...
  const structuredData = generateCityStructuredData('donceel', 'Donceel', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Donceel", url: "https://shineandgo.be/nettoyage-voiture-donceel" },
    },
    faqs: [
      {
