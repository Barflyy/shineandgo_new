...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage voiture Donceel à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-donceel.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Donceel",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Donceel | Shine&Go (service premium)",
      description: "Lavage voiture Donceel à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-donceel.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function DonceelPage() {
  ...
  const structuredData = generateCityStructuredData('donceel', 'Donceel', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Donceel",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Donceel", url: "https://www.shineandgo.be/nettoyage-voiture-donceel" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Donceel ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="donceel" 
        cityName="Donceel"
        csvData={getCSVCityData('nettoyage-voiture-donceel')}
      />
    </>
  );
}
