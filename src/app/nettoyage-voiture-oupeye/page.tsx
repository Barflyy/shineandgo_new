...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-oupeye',
  },
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Oupeye - Lavage Auto Pro',
    description: 'Expert du nettoyage auto à Oupeye. Nous venons chez vous pour un lavage complet intérieur et extérieur. Déplacement gratuit. Résultat garanti.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Oupeye Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Oupeye",
                "item": "https://shineandgo.be/nettoyage-voiture-oupeye"
            }
        ,
    {
        "@context": "https://schema.org",
