...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-jemeppe",
    },
    openGraph: {
      title: "Lavage voiture à Jemeppe (Wallonie) | Shine&Go se déplace chez vous",
      description: "Nettoyage auto mobile à Jemeppe : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-jemeppe.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage voiture à Jemeppe (Wallonie) | Shine&Go se déplace chez vous",
      description: "Nettoyage auto mobile à Jemeppe : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-jemeppe.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function JemeppePage() {
  ...
  const structuredData = generateCityStructuredData('jemeppe', 'Jemeppe', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Jemeppe", url: "https://shineandgo.be/nettoyage-voiture-jemeppe" },
    },
    faqs: [
      {
