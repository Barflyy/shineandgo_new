...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-hermalle',
  },
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Hermalle - Lavage Pro',
    description: 'Lavage auto professionnel à Hermalle-sous-Argenteau. Nous intervenons chez vous. Nettoyage complet, anti-rayures, produits écologiques. Devis immédiat.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Hermalle Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Esthétique automobile et lavage à domicile à Hermalle</h1>
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Nettoyage voiture Hermalle`}
                      fill
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Hermalle",
                "item": "https://shineandgo.be/nettoyage-voiture-hermalle"
            }
        ]
    },
    {
