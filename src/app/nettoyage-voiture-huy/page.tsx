...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage et nettoyage voiture à domicile à Huy. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-huy.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Huy",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Lavage voiture à Huy (Wallonie) | Shine&Go se déplace chez vous",
      description: "Lavage et nettoyage voiture à domicile à Huy. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-huy.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function HuyPage() {
  ...
  const structuredData = generateCityStructuredData('huy', 'Huy', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Huy",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Huy", url: "https://www.shineandgo.be/nettoyage-voiture-huy" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Huy ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="huy" 
        cityName="Huy"
        csvData={getCSVCityData('nettoyage-voiture-huy')}
      />
    </>
  );
}
