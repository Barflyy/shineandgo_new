...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-huy",
    },
    openGraph: {
      title: "Lavage voiture à Huy (Wallonie) | Shine&Go se déplace chez vous",
      description: "Lavage et nettoyage voiture à domicile à Huy. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-huy.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage voiture à Huy (Wallonie) | Shine&Go se déplace chez vous",
      description: "Lavage et nettoyage voiture à domicile à Huy. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-huy.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function HuyPage() {
  ...
  const structuredData = generateCityStructuredData('huy', 'Huy', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Huy", url: "https://shineandgo.be/nettoyage-voiture-huy" },
    },
    faqs: [
      {
