...
export const metadata: Metadata = {
  ...
  description: 'Nettoyage auto à Chaudfontaine. Service mobile de qualité. Nous venons chez vous pour un lavage complet intérieur et extérieur. Devis gratuit.',
  alternates: {
