import { ArrowRight, Check, Star, Sparkles, Car, Armchair, Clock } from 'lucide-react'
...
export const metadata: Metadata = {
  title: 'Lavage Voiture Chaudfontaine - Lavage à Domicile',
  description: 'Lavage voiture à Chaudfontaine. Service mobile de qualité. Nous venons chez vous pour un lavage complet intérieur et extérieur. Devis gratuit.',
  alternates: {
        ...
        <section className="relative pt-16 pb-6 sm:pt-20 sm:pb-10 md:pt-28 md:pb-12 overflow-hidden bg-white dark:bg-slate-950">
          <div className="container mx-auto px-6 sm:px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 dark:text-white mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>Lavage voiture professionnel à Chaudfontaine</h1>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
                Expert en lavage voiture à <span className="font-semibold">Chaudfontaine</span>
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed text-pretty">
                Votre voiture mérite le meilleur traitement. Shine&Go se déplace partout à Chaudfontaine pour un nettoyage intérieur et extérieur de qualité. Que vous soyez à Embourg, Beaufays ou Vaux-sous-Chèvremont, nos experts locaux connaissent les exigences des conducteurs de la région et adaptent leurs soins.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-8 text-center">
              Lavage auto dans la cité thermale
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  De Vaux-sous-Chèvremont à Beaufays, Chaudfontaine est une commune étendue et vallonnée. Nous venons jusqu'à votre domicile pour un service 5 étoiles.
                </p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                  Nos clients à Chaudfontaine apprécient particulièrement nos formules complètes qui remettent le véhicule à neuf sans qu'ils aient à quitter leur domicile.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white">Zone Chaudfontaine</h3>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-4 text-balance">
                  Zone d'intervention Chaudfontaine
                </h2>
                <p className="text-lg text-gray-600 dark:text-gray-400 text-pretty">
                  Nous intervenons à Chaudfontaine et alentours
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                {[
                  ...
                  { name: 'Vaux-sous-Chèvremont', href: '/lavage-voiture-chaudfontaine' },
                  { name: 'Beaufays', href: '/lavage-voiture-chaudfontaine' },
                  { name: 'Liège', href: '/lavage-voiture-liege' },
                  { name: 'Trooz', href: '/lavage-voiture-trooz' },
                  { name: 'Chênée', href: '/lavage-voiture-liege' },
                ].map((city) => (
                  <Link
                    key={city.name}
                    href={city.href}
