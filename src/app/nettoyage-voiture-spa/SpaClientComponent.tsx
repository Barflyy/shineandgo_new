...
export default function SpaClientComponent() {
  // --- ÉTATS GLOBAUX ---
  ...
  const handleBooking = () => {
    try {
      window.open('https://wa.me/32472303701?text=Bonjour,%20je%20souhaite%20r%C3%A9server%20un%20nettoyage%20voiture%20premium%20%C3%A0%20Spa', '_blank', 'noopener,noreferrer');
    } catch (error) {
  ...
  const faqItems = [
    {
      question: "Quel est le tarif d'un nettoyage voiture premium à Spa ?",
    ...
    {
      question: "Intervenez-vous dans toute la région de Spa ?",
      answer: "Oui, nous intervenons dans toute la région de Spa et environs (Stavelot, Malmedy, Verviers) avec un déplacement gratuit jusqu'à 25 km. Au-delà, un supplément peut s'appliquer selon la distance. Contactez-nous pour vérifier la disponibilité dans votre zone."
    },
    {
          ...
          <div className="relative min-h-screen flex items-center justify-center bg-white">
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900">
                Lavage Voiture Spa | Nettoyage Premium Mobile - Dès 65€
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-gray-700">
                Vous cherchez un <strong>lavage voiture premium</strong> à Spa ? Shine&Go vous propose un service de 
                <strong> nettoyage voiture mobile</strong> professionnel à domicile. Notre <strong>nettoyage voiture</strong> à Spa utilise 
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="https://wa.me/32472303701?text=Bonjour,%20je%20souhaite%20un%20devis%20gratuit%20pour%20un%20lavage%20voiture%20premium%20%C3%A0%20Spa"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-black leading-tight tracking-tight text-slate-900 mb-4">
                FAQ – Lavage Voiture Premium Spa
              </h2>
              <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto">
                Questions fréquentes sur notre service de nettoyage voiture mobile à Spa
              </p>
            </div>
