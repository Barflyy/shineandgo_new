...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-blegny',
  },
  openGraph: {
    title: 'Car Wash Mobile Blegny - Nettoyage à Domicile',
    description: 'Nettoyage voiture à Blegny. Lavage auto professionnel directement chez vous. Intérieur et extérieur. Service de qualité, déplacement gratuit.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Blegny Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Car Wash Mobile
              <span className="block font-semibold mt-2 text-gray-900">à Blegny</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Votre voiture lavée devant chez vous à Blegny.
              <span className="block mt-2 text-base text-gray-400 font-normal">Pratique • Rapide • Soigné</span>
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                { name: 'Saive', href: '/nettoyage-voiture-blegny' },
                { name: 'Trembleur', href: '/nettoyage-voiture-blegny' },
                { name: 'Mortier', href: '/nettoyage-voiture-blegny' },
                { name: 'Housse', href: '/nettoyage-voiture-blegny' },
                { name: 'Barchon', href: '/nettoyage-voiture-blegny' },
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-gray-900 mb-4 sm:mb-6 leading-tight">
              Blegny,
              <span className="block">votre voiture propre en un clic</span>
            </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Nettoyage Voiture à Domicile Blegny",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Shine&Go",
            ...
            "description": "Service de nettoyage automobile à domicile à Blegny. Lavage intérieur et extérieur, detailing, protection céramique.",
            "offers": {
              "@type": "Offer",
              "price": "65",
              "priceCurrency": "EUR"
