...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-ensival',
  },
  openGraph: {
    title: 'Nettoyage Auto Ensival - Lavage Mobile',
    description: 'Nettoyage voiture à domicile à Ensival. Nous venons chez vous pour un lavage complet. Intérieur, extérieur, soins carrosserie. Devis gratuit.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Ensival Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Ensival",
                "item": "https://shineandgo.be/nettoyage-voiture-ensival"
            }
        ,
    {
        "@context": "https://schema.org",
