...
export const metadata: Metadata = {
  title: 'Nettoyage Voiture à Domicile Battice - Intérieur & Extérieur',
  description: 'Expert du nettoyage véhicule à Battice. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
  alternates: {
  ...
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Battice - Intérieur & Extérieur',
    description: 'Expert du nettoyage véhicule à Battice. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
    url: 'https://shineandgo.be/nettoyage-voiture-battice',
    siteName: 'Shine&Go',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Battice Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light text-gray-900 mb-4 text-balance">
                Zone d'intervention Battice & Plateau
              </h2>
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Nettoyage voiture Battice`}
                      fill
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Battice",
                "item": "https://shineandgo.be/nettoyage-voiture-battice"
            }
        ,
    {
        "@context": "https://schema.org",
