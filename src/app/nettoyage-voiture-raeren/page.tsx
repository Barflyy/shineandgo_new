...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-raeren.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage voiture à Raeren (Wallonie) | Shine&Go se déplace chez vous",
      description: "Lavage et nettoyage voiture à domicile à Raeren. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-raeren.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function RaerenPage() {
  ...
  const structuredData = generateCityStructuredData('raeren', 'Raeren', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Raeren", url: "https://www.shineandgo.be/nettoyage-voiture-raeren" },
    },
    faqs: [
      {
