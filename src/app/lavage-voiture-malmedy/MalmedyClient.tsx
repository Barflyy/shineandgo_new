...
function HeroSection() {
    const handleBooking = () => { window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage voiture à Malmedy. 🚗', '_blank'); };
                ...
                <div className="max-w-3xl mx-auto">
                    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} className="flex justify-center mb-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200/80 shadow-sm">
                            ...
                            <span className="text-xs font-semibold text-slate-700">Hautes Fagnes & Circuit F1</span>
                        </div>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }} className="text-center mb-6">
                        <h1 className="font-display text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-4">
                            ...
                            <span className="relative inline-block">
                                <span className="relative z-10 bg-gradient-to-r from-sky-500 to-emerald-500 bg-clip-text text-transparent">à Malmedy</span>
                        ...
                        <p className="text-lg sm:text-xl text-slate-600 max-w-xl mx-auto leading-relaxed">
                            Retour des Fagnes boueux ? Track day à Spa-Francorchamps ? <strong className="text-slate-900">On remet votre voiture à neuf</strong> sans que vous quittiez Malmedy.
                        </p>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="flex flex-col gap-3 mb-8">
                        ...
                        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handleBooking} className="w-full sm:w-auto sm:mx-auto group relative overflow-hidden px-8 py-5 bg-slate-900 text-white font-bold text-lg rounded-2xl shadow-2xl shadow-slate-900/25 transition-all duration-300">
                            <span className="relative z-10 flex items-center justify-center gap-3"><CalendarCheck className="w-5 h-5" /> Réserver à Malmedy <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" /></span>
...
function BenefitsSection() {
    const benefits = [
        { icon: Car, title: "Spécialiste post-circuit", description: "Poussière de freins, insectes écrasés, traces de pneus... On connaît les dégâts d'un track day.", color: "sky" },
        { icon: Droplets, title: "Traitement conditions extrêmes", description: "Neige, sel, boue des Fagnes : l'hiver ardennais est rude. On protège votre carrosserie.", color: "emerald" },
        { icon: Shield, title: "4x4 et SUV bienvenus", description: "Vous roulez sur les chemins de Waimes ou Robertville ? On traite les châssis encrassés.", color: "violet" },
    ];
        ...
        <section className="py-16 sm:py-20 bg-white">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Pourquoi choisir Shine&Go à Malmedy ?</h2>
                </motion.div>
        ...
        <section id="services" className="py-16 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    ...
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-3">Tarifs lavage voiture à Malmedy</h2>
                    <p className="text-slate-600 max-w-md mx-auto">Tarifs transparents, déplacement gratuit à Malmedy et environs.</p>
                </motion.div>
...
function TestimonialsSection() {
    const testimonials = [
        { name: 'Olivier S.', location: 'Malmedy', text: 'Track day à Francorchamps avec ma GT3. Poussière de freins partout, jantes noires. 2h plus tard, elle était showroom. Ces gars connaissent les voitures de sport.', avatar: '👨' },
        { name: 'Amélie D.', location: 'Waimes', text: 'On habite près des Fagnes, notre Dacia Duster est toujours plein de boue. Nathan a même nettoyé les passages de roues. Impeccable !', avatar: '👩' },
        { name: 'Thomas M.', location: 'Stavelot', text: 'L\'hiver dernier, ma voiture était blanche de sel. Ils ont tout enlevé et appliqué une protection. Aucune trace de corrosion depuis.', avatar: '👨' },
    ];
        ...
        <section className="py-16 sm:py-24 bg-white overflow-hidden">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    ...
                    <p className="text-slate-600">Ce que nos clients disent de nous à Malmedy</p>
                </motion.div>
...
function FAQSection() {
    const faqs = [
        { question: "Vous pouvez venir après un track day à Francorchamps ?", answer: "C'est notre spécialité ! Poussière de freins, gomme fondue sur la carrosserie, insectes... On connaît les dégâts d'une journée circuit. Réservez pour le soir même ou le lendemain." },
        { question: "Ma voiture est couverte de boue des Fagnes, c'est un problème ?", answer: "Pas du tout, on adore ça ! On traite les 4x4 et SUV qui reviennent des chemins de Botrange ou du barrage de Robertville. Châssis et passages de roues inclus." },
        { question: "L'hiver est rude ici, vous traitez les dégâts du sel ?", answer: "Malmedy et les Fagnes, c'est 5 mois de sel sur les routes. On utilise un traitement décontaminant spécifique et on peut appliquer une protection céramique pour l'hiver." },
        { question: "Vous venez jusqu'à Waimes ou Stavelot ?", answer: "Oui ! Malmedy, Stavelot, Waimes, Bévercé, Robertville... Toute la région des Hautes Fagnes est couverte, déplacement gratuit." }
    ];
...
function CTASection() {
    const handleBooking = () => { window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage voiture à Malmedy. 🚗', '_blank'); };
    const zones = ['Spa', 'Stavelot', 'Waimes', 'Verviers', 'Liège'];
        ...
        <section className="relative py-16 sm:py-24 overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto px-5 text-center">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                    ...
                    <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">Prêt pour une voiture<br className="sm:hidden" /> comme neuve à Malmedy ?</h2>
                    ...
                    <div className="pt-8 border-t border-white/10">
                        <p className="text-sm text-white/50 mb-4 flex items-center justify-center gap-2"><MapPin className="w-4 h-4" /> Zones proches de Malmedy</p>
...
export default function MalmedyClient() {
    return (
