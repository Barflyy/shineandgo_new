...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-trois-ponts",
    },
    openGraph: {
      title: "Nettoyage voiture Trois-ponts à domicile | Résultat showroom garanti",
      description: "Nettoyage auto mobile à Trois-ponts : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-trois-ponts.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Trois-ponts à domicile | Résultat showroom garanti",
      description: "Nettoyage auto mobile à Trois-ponts : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-trois-ponts.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function TroispontsPage() {
  ...
  const structuredData = generateCityStructuredData('trois-ponts', 'Trois-ponts', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Trois-ponts", url: "https://shineandgo.be/nettoyage-voiture-trois-ponts" },
    },
    faqs: [
      {
