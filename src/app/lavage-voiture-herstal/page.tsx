...
export const metadata: Metadata = {
  title: 'Lavage Voiture Herstal - Lavage à Domicile',
  description: 'Lavage voiture à Herstal. Service mobile de qualité. Nous venons chez vous pour un lavage complet intérieur et extérieur. Devis gratuit.',
  alternates: {
      ...
      <section className="relative pt-16 pb-6 sm:pt-20 sm:pb-10 md:pt-28 md:pb-12 overflow-hidden bg-white dark:bg-slate-950">
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 dark:text-white mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>Lavage voiture professionnel à Herstal</h1>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage voiture à <span className="font-semibold">Herstal</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed text-pretty">
              Votre voiture mérite le meilleur traitement. Shine&Go se déplace partout à Herstal pour un nettoyage intérieur et extérieur de qualité. En tant qu'experts locaux à Herstal, nous connaissons les exigences des conducteurs de la région et adaptons nos soins aux conditions climatiques belges.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-8 text-center">
              Lavage auto dans la cité armurière
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  De la Préalle à Vottem, Herstal est vaste. Notre service mobile couvre l'entièreté de la commune. Nous traitons souvent des véhicules exposés aux retombées industrielles ou urbaines.
                </p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                  Notre traitement carrosserie permet de supprimer le film routier tenace souvent présent dans les zones à forte densité de trafic.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white">Zone Herstal</h3>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-4 text-balance">
                Zone d'intervention Herstal
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 text-pretty">
                Nous intervenons à Herstal et Andrimont
              </p>
            </div>
