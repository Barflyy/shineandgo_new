...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-ans.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Ans à domicile | Résultat showroom garanti",
      description: "Lavage et nettoyage voiture à domicile à Ans. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-ans.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function AnsPage() {
  ...
  const structuredData = generateCityStructuredData('ans', 'Ans', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Ans", url: "https://shineandgo.be/nettoyage-voiture-ans" },
    },
    faqs: [
      {
