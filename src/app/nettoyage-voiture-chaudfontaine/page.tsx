...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage voiture Chaudfontaine à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-chaudfontaine.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Chaudfontaine",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Chaudfontaine | Shine&Go (service premium)",
      description: "Lavage voiture Chaudfontaine à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-chaudfontaine.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function ChaudfontainePage() {
  ...
  const structuredData = generateCityStructuredData('chaudfontaine', 'Chaudfontaine', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Chaudfontaine",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Chaudfontaine", url: "https://www.shineandgo.be/nettoyage-voiture-chaudfontaine" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Chaudfontaine ?",
  ...
  return (
    <>
      ...
      />
      <CityPageTemplateNew 
        citySlug="chaudfontaine" 
        cityName="Chaudfontaine"
        csvData={getCSVCityData('nettoyage-voiture-chaudfontaine')}
      />
    </>
  );
}
