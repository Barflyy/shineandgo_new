...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-chaudfontaine.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Chaudfontaine | Shine&Go (service premium)",
      description: "Lavage voiture Chaudfontaine à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-chaudfontaine.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function ChaudfontainePage() {
  ...
  const structuredData = generateCityStructuredData('chaudfontaine', 'Chaudfontaine', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Chaudfontaine", url: "https://shineandgo.be/nettoyage-voiture-chaudfontaine" },
    },
    faqs: [
      {
