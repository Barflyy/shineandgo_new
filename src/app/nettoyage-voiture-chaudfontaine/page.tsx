...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-chaudfontaine',
  },
  openGraph: {
    title: 'Nettoyage Voiture Chaudfontaine - Service Premium',
    description: 'Lavage voiture à domicile à Chaudfontaine et Embourg. Service 5 étoiles. Nettoyage complet intérieur/extérieur. Produits haut de gamme.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Chaudfontaine Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Chaudfontaine",
                "item": "https://shineandgo.be/nettoyage-voiture-chaudfontaine"
            }
        ,
    {
        "@context": "https://schema.org",
