...
export const metadata: Metadata = {
  title: 'Nettoyage Voiture à Domicile Embourg - Intérieur & Extérieur',
  description: 'Expert du nettoyage véhicule à Embourg. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
  alternates: {
  ...
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Embourg - Intérieur & Extérieur',
    description: 'Expert du nettoyage véhicule à Embourg. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
    url: 'https://shineandgo.be/nettoyage-voiture-embourg',
    siteName: 'Shine&Go',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Embourg Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Embourg",
                "item": "https://shineandgo.be/nettoyage-voiture-embourg"
            }
        ,
    {
        "@context": "https://schema.org",
