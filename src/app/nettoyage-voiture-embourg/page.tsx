...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-embourg.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage voiture à Embourg (Wallonie) | Shine&Go se déplace chez vous",
      description: "Lavage et nettoyage voiture à domicile à Embourg. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-embourg.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function EmbourgPage() {
  ...
  const structuredData = generateCityStructuredData('embourg', 'Embourg', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Embourg", url: "https://www.shineandgo.be/nettoyage-voiture-embourg" },
    },
    faqs: [
      {
