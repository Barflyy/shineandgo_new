...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Besoin d’un car wash à domicile à Malmedy ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-malmedy.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Malmedy",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Malmedy | Shine&Go (service premium)",
      description: "Besoin d’un car wash à domicile à Malmedy ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-malmedy.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function MalmedyPage() {
  ...
  const structuredData = generateCityStructuredData('malmedy', 'Malmedy', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Malmedy",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Malmedy", url: "https://www.shineandgo.be/nettoyage-voiture-malmedy" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Malmedy ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="malmedy" 
        cityName="Malmedy"
        csvData={getCSVCityData('nettoyage-voiture-malmedy')}
      />
    </>
  );
}
