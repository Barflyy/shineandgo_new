...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-malmedy',
  },
  openGraph: {
    title: 'Esthétique Auto Malmedy - Lavage Domicile',
    description: 'Service de nettoyage voiture à domicile à Malmedy. Nous nous déplaçons chez vous. Lavage intérieur et extérieur, protection céramique. Devis gratuit.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Malmedy Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Nettoyage voiture Malmedy`}
                      fill
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Malmedy",
                "item": "https://shineandgo.be/nettoyage-voiture-malmedy"
            }
        ,
    {
        "@context": "https://schema.org",
