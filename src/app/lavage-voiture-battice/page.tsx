...
export const metadata: Metadata = {
  title: 'Lavage Voiture Battice à Domicile - Intérieur & Extérieur | Shine&Go',
  description: 'Lavage voiture à domicile à Battice. Service de lavage auto professionnel, nettoyage véhicule intérieur/extérieur. Prix clairs dès 65€. Déplacement gratuit. ☎ 0472 30 37 01',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lavage voiture domicile Battice - Shine&Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
...
export default function BatticePage() {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Combien coûte un lavage voiture à domicile à Battice ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nos tarifs à Battice démarrent à 65€ pour un lavage intérieur, 50€ pour l'extérieur, et 100€ pour la formule complète. Le déplacement est inclus."
        }
      },
      {
        "@type": "Question",
        "name": "Intervenez-vous à Battice pour le lavage voiture ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Oui, nous intervenons à Battice et dans toutes les communes environnantes. Réservez en ligne ou par téléphone."
        }
      },
      {
        "@type": "Question",
        "name": "Quels services de lavage proposez-vous à Battice ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nous proposons le lavage intérieur, extérieur et complet à Battice. Nous utilisons des produits professionnels Koch-Chemie."
        }
      }
    ]
  }
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 dark:text-white mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Expert en Detailing et Nettoyage Auto à Domicile : Battice</h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Lavage voiture professionnel directement chez vous à Battice. Profitez d'un service premium avec les meilleurs produits du marché.
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage auto à <span className="font-semibold">Battice</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed text-pretty">
              Plus besoin de vous déplacer au car wash. Nous venons à votre domicile à Battice pour un résultat d'exception. En tant qu'experts locaux à Battice, nous connaissons les exigences des conducteurs de la région et adaptons nos soins aux conditions climatiques belges.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-4 text-balance">
                Car Wash & Lavage Auto à domicile à Battice
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 text-pretty">
                Nous couvrons Battice et tous les villages avoisinants
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group p-8 bg-gradient-to-br from-orange-50 to-white rounded-2xl border border-orange-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center">
                ...
                <p className="text-sm text-gray-600 text-pretty">Nous venons à Battice quand cela vous arrange, à domicile ou au bureau</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-4 text-balance">
              Tarifs Car Wash & Lavage Battice</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 text-pretty">
              Formules claires, déplacement compris
            </p>
          </div>
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Lavage voiture Battice`}
                      fill
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
              <a
                href="https://www.google.com/search?q=shine+and+go+battice"
                target="_blank"
                rel="noopener noreferrer"
...
<section className="py-16 sm:py-20 md:py-32 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-gray-900 mb-4 sm:mb-6 leading-tight">
              Votre voiture propre à Battice ?
            </h2>

            <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-12">
              Prenez rendez-vous maintenant. On s'occupe de tout.
            </p>
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "description": "Service de nettoyage et detailing automobile à domicile à Battice.",
        "url": "https://shineandgo.be/lavage-voiture-battice",
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Battice",
                "item": "https://shineandgo.be/lavage-voiture-battice"
            }
        ,
    {
        "@context": "https://schema.org",
