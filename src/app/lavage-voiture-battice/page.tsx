        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                Nettoyage voiture à domicile à Battice
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs sm:text-sm">
                <li><Link href="/nettoyage-voiture-herve" className="text-gray-600 hover:text-gray-900 transition-colors">Battice</Link></li>
          ...
          <div className="pt-6 sm:pt-8 border-t border-gray-100 text-center">
            <div className="text-xs sm:text-sm text-gray-500">
              © 2025 Shine&Go. Nettoyage voiture Battice.
            </div>
          </div>
        </div>
      </footer>
