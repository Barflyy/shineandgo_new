...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-dalhem',
  },
  openGraph: {
    title: 'Nettoyage Voiture Dalhem - Service Mobile à Domicile',
    description: 'Lavage auto professionnel à Dalhem. Shine&Go se déplace chez vous pour nettoyer votre véhicule. Intérieur, extérieur, detailing. Devis et RDV rapides.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Dalhem Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Dalhem",
                "item": "https://shineandgo.be/nettoyage-voiture-dalhem"
            }
        ,
    {
        "@context": "https://schema.org",
