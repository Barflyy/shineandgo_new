...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-flemalle",
    },
    openGraph: {
      title: "Nettoyage voiture Flemalle à domicile | Résultat showroom garanti",
      description: "Lavage et nettoyage voiture à domicile à Flemalle. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-flemalle.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Flemalle à domicile | Résultat showroom garanti",
      description: "Lavage et nettoyage voiture à domicile à Flemalle. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-flemalle.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function FlemallePage() {
  ...
  const structuredData = generateCityStructuredData('flemalle', 'Flemalle', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Flemalle", url: "https://shineandgo.be/nettoyage-voiture-flemalle" },
    },
    faqs: [
      {
