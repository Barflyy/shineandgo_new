...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage et nettoyage voiture à domicile à Flemalle. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-flemalle.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Flemalle",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Flemalle à domicile | Résultat showroom garanti",
      description: "Lavage et nettoyage voiture à domicile à Flemalle. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-flemalle.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function FlemallePage() {
  // Générer les données structurées avec toutes les informations du CSV
  const structuredData = generateCityStructuredData('flemalle', 'Flemalle', {
    title: "Nettoyage voiture Flemalle à domicile – Résultat showroom garanti",
    description: "Lavage et nettoyage voiture à domicile à Flemalle. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
    price: "79",
    currency: "EUR",
    ...
    imageDescription: "Nettoyage voiture à domicile à Flemalle",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Flemalle", url: "https://www.shineandgo.be/nettoyage-voiture-flemalle" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Flemalle ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="flemalle" 
        cityName="Flemalle"
        csvData={getCSVCityData('nettoyage-voiture-flemalle')}
      />
    </>
  );
}
