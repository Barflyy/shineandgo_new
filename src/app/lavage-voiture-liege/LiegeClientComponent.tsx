...
export default function LiegeClientComponent() {
  // --- ÉTATS GLOBAUX ---
  ...
  const handleBooking = () => {
    try {
      window.open('https://wa.me/32472303701?text=Bonjour,%20je%20souhaite%20r%C3%A9server%20un%20lavage%20voiture%20%C3%A0%20Li%C3%A8ge', '_blank', 'noopener,noreferrer');
    } catch (error) {
  ...
  const faqItems = [
    ...
    {
      question: "Quels produits utilisez-vous pour le lavage voiture ?",
    ...
    {
      question: "Intervenez-vous dans toute l'agglomération de Liège ?",
      answer: "Oui, nous intervenons dans toute l'agglomération de Liège : Centre, Grivegnée, Angleur, Bressoux, Chênée, Sclessin, Jupille, Outremeuse et tous les quartiers environnants avec un déplacement gratuit jusqu'à 25 km. Au-delà, un supplément peut s'appliquer selon la distance. Contactez-nous pour vérifier la disponibilité dans votre zone."
    },
    {
      question: "Que faire si je ne suis pas satisfait du lavage ?",
          ...
          <div className="flex items-center justify-between h-12 sm:h-14 md:h-16 lg:h-18">
            ...
            <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
              ...
              <button
                ...
                aria-label="Réserver un lavage voiture maintenant"
          ...
          <div className="relative min-h-screen flex items-center justify-center bg-white">
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="https://wa.me/32472303701?text=Bonjour,%20je%20souhaite%20un%20devis%20gratuit%20pour%20un%20lavage%20voiture%20%C3%A0%20Li%C3%A8ge"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-black leading-tight tracking-tight text-slate-900 mb-4">
                FAQ – Lavage Voiture Liège
              </h2>
              <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto">
                Questions fréquentes sur notre service de lavage voiture mobile à Liège
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-slate-800 border border-slate-700 rounded-xl p-8 md:p-12 shadow-lg">
                ...
                <h3 className="text-2xl md:text-3xl font-black text-white mb-4">
                  Votre voiture mérite le meilleur lavage
                </h3>
                
                <p className="text-slate-300 mb-8 text-lg leading-relaxed max-w-2xl mx-auto">
                  Shine&Go – Service Premium de Lavage Voiture Mobile à Liège
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 shadow-lg">
              ...
              <p className="text-slate-300 leading-relaxed text-sm">
                Lavage voiture mobile à domicile à Liège et Wallonie.
                <br />
