...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-saint-nicolas',
  },
  openGraph: {
    title: 'Nettoyage Voiture Saint-Nicolas - Service Domicile',
    description: 'Lavage auto à Saint-Nicolas. Shine&Go vient chez vous pour nettoyer votre voiture. Intérieur et extérieur. Résultat impeccable garanti. Devis gratuit.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Saint-Nicolas Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-4 text-balance">
              Tarifs Nettoyage Saint-Nicolas
            </h2>
            <p className="text-lg text-gray-600 text-pretty">
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Nettoyage voiture Saint-Nicolas`}
                      fill
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Saint-Nicolas",
                "item": "https://shineandgo.be/nettoyage-voiture-saint-nicolas"
            }
        ,
    {
        "@context": "https://schema.org",
