...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-lambermont',
  },
  openGraph: {
    title: 'Lavage Auto Lambermont - Nettoyage Mobile',
    description: 'Nettoyage voiture à Lambermont. Service premium à domicile. Lavage complet, produits écologiques, finition parfaite. Réservez maintenant.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Lambermont Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Lambermont",
                "item": "https://shineandgo.be/nettoyage-voiture-lambermont"
            }
        ]
    },
    {
