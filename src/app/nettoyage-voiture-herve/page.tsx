...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Besoin d’un car wash à domicile à Herve ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-herve.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Herve : intérieur & extérieur | Shine&Go",
      description: "Besoin d’un car wash à domicile à Herve ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-herve.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function HervePage() {
  ...
  const structuredData = generateCityStructuredData('herve', 'Herve', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Herve",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Herve", url: "https://www.shineandgo.be/nettoyage-voiture-herve" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Herve ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="herve" 
        cityName="Herve"
        csvData={getCSVCityData('nettoyage-voiture-herve')}
      />
    </>
  );
}
