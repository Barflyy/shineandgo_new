          ...
          <div className="relative min-h-screen flex items-center justify-center bg-white">
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900">
                🚗 Nettoyage voiture à domicile Herve – Service premium
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-gray-700">
                Votre voiture mérite le meilleur ! Shine&Go vous propose un service de nettoyage voiture à domicile à Herve et alentours, avec des produits professionnels haut de gamme. ✨ Résultat showroom garanti.
              </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Nettoyage voiture à domicile Herve",
            "description": "Service de nettoyage voiture à domicile à Herve et alentours",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Shine&Go",
              "address": {
            ...
            "offers": {
              ...
              "price": "49",
              "priceCurrency": "EUR",
              "description": "Nettoyage voiture à domicile Herve"
            }
          })
        }}
      />
