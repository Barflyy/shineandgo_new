...
export const metadata: Metadata = {
    title: 'Lavage Voiture Verviers - Lavage à Domicile',
    description: 'Lavage voiture à Verviers. Service mobile de qualité. Nous venons chez vous pour un lavage complet intérieur et extérieur. Devis gratuit.',
    alternates: {
                ...
                <section className="relative pt-16 pb-6 sm:pt-20 sm:pb-10 md:pt-28 md:pb-12 overflow-hidden bg-white dark:bg-slate-950">
                    <div className="container mx-auto px-6 sm:px-6 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 dark:text-white mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>Lavage voiture professionnel à Verviers</h1>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="max-w-3xl mx-auto text-center">
                            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
                                Expert en lavage voiture à <span className="font-semibold">Verviers</span>
                            </h2>
                            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed text-pretty">
                                Votre voiture mérite le meilleur traitement. Shine&Go se déplace partout à Verviers pour un nettoyage intérieur et extérieur de qualité. En tant qu'experts locaux à Verviers, nous connaissons les exigences des conducteurs de la région et adaptons nos soins aux conditions climatiques belges.
                            </p>
                        </div>
                    </div>
                </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-8 text-center">
              Lavage auto dans la Capitale de l'Eau
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  Verviers et son agglomération sont notre base. Nous connaissons la ville par cœur, de Heusy à Stembert. L'eau, on connait, mais pour le lavage, on utilise la nôtre ou la vôtre avec parcimonie et efficacité.
                </p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                  Nous intervenons régulièrement dans le centre comme en périphérie pour redonner le sourire aux automobilistes verviétois.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white">Zone Verviers</h3>
                        ...
                        <div className="max-w-5xl mx-auto">
                            <div className="text-center mb-12">
                                <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-4 text-balance">
                                    Zone d'intervention Verviers
                                </h2>
                                <p className="text-lg text-gray-600 dark:text-gray-400 text-pretty">
                                    Nous intervenons à Verviers et alentours
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                                {[
                                    ...
                                    { name: 'Hodimont', href: '/lavage-voiture-verviers' }, // Use Verviers URL as backup/variant
                                ].map((city) => (
                                    <Link
                                        key={city.name}
                                        href={city.href}
