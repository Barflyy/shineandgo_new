...
export const metadata: Metadata = {
  title: 'Lavage Voiture Verviers à Domicile - Intérieur & Extérieur | Shine&Go',
  description: 'Lavage voiture à domicile à Verviers. Service de lavage auto professionnel, nettoyage véhicule intérieur/extérieur. Prix clairs dès 65€. Déplacement gratuit. ☎ 0472 30 37 01',
  alternates: {
    canonical: 'https://shineandgo.be/lavage-voiture-verviers',
  },
  openGraph: {
    title: 'Lavage Voiture Verviers à Domicile - Intérieur & Extérieur | Shine&Go',
    description: 'Lavage voiture à domicile à Verviers. Service de lavage auto professionnel, nettoyage véhicule intérieur/extérieur. Prix clairs dès 65€. Déplacement gratuit. ☎ 0472 30 37 01',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lavage voiture domicile Verviers - Shine&Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
...
export default function VerviersPage() {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Combien coûte un lavage voiture à domicile à Verviers ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nos tarifs à Verviers démarrent à 65€ pour un lavage intérieur, 50€ pour l'extérieur, et 100€ pour la formule complète. Le déplacement est inclus."
        }
      },
      {
        "@type": "Question",
        "name": "Intervenez-vous à Verviers pour le lavage voiture ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Oui, nous intervenons à Verviers et dans toutes les communes environnantes. Réservez en ligne ou par téléphone."
        }
      },
      {
        "@type": "Question",
        "name": "Quels services de lavage proposez-vous à Verviers ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nous proposons le lavage intérieur, extérieur et complet à Verviers. Nous utilisons des produits professionnels Koch-Chemie."
        }
      }
    ]
  }
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 dark:text-white mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Expert en Detailing et Nettoyage Auto à Domicile : Verviers</h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Lavage voiture professionnel directement chez vous à Verviers. Profitez d'un service premium avec les meilleurs produits du marché.
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage auto à <span className="font-semibold">Verviers</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed text-pretty">
              Shine&Go s'occupe de votre voiture à Verviers. Profitez d'un service professionnel méticuleux avec les produits Koch-Chemie. Que vous soyez situé en plein centre de Verviers ou dans les quartiers résidentiels en périphérie, notre unité mobile est équipée pour intervenir en totale autonomie.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-4 text-balance">
              Tarifs Car Wash & Lavage Verviers</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 text-pretty">
              Une tarification simple, sans frais cachés pour le déplacement
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto items-start">
            ...
            <article className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 h-full">
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un nettoyage intérieur à Verviers - 65€"
            ...
            <article className="relative group bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-2xl hover:shadow-blue-900/20 hover:-translate-y-1 transition-all duration-300 md:-mt-4 md:mb-4 z-10">
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite le nettoyage complet à Verviers - 120€"
            ...
            <article className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 h-full">
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un lavage extérieur à Verviers - 85€"
                className="block w-full py-4 border border-gray-200 text-gray-900 font-medium rounded-xl text-center hover:bg-gray-50 hover:border-gray-300 transition-all"
              >
                Réserver
              </a>
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Lavage voiture Verviers`}
                      fill
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
              <a
                href="https://www.google.com/search?q=shine+and+go+verviers"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-gray-900 mb-4 sm:mb-6 leading-tight">
              Prenez rendez-vous à Verviers aujourd'hui
            </h2>

            <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-12">
              Réservez votre créneau à Verviers en quelques clics. Dispo sous 48h.
            </p>
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Verviers",
                "item": "https://shineandgo.be/lavage-voiture-verviers"
            }
        ,
    {
        "@context": "https://schema.org",
