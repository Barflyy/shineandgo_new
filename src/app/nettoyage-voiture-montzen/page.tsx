...
export default function MontzenPage() {
  ...
  const structuredData = generateCityStructuredData('montzen', 'Montzen', {
    ...
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Montzen ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="montzen" 
        cityName="Montzen"
        csvData={getCSVCityData('nettoyage-voiture-montzen')}
      />
    </>
  );
}
