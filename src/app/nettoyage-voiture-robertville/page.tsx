...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-robertville.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Robertville : intérieur & extérieur | Shine&Go",
      description: "Nettoyage auto mobile à Robertville : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-robertville.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function RobertvillePage() {
  ...
  const structuredData = generateCityStructuredData('robertville', 'Robertville', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Robertville", url: "https://www.shineandgo.be/nettoyage-voiture-robertville" },
    },
    faqs: [
      {
