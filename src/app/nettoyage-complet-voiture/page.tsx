...
export default function NettoyageCompletPage() {
  ...
  return (
    <>
      <Head>
        <title>Nettoyage Complet Voiture | Habitacle Impeccable dès 120€ - Shine&Go</title>
        <meta name="description" content="Nettoyage complet voiture à domicile. Aspiration complète, nettoyage surfaces, vitres, protection UV. Service mobile en 90 min. Produits Koch-Chemie. ☎ 0472 30 37 01" />
      </Head>
        ...
        <div className="container mx-auto px-6 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold text-slate-900 mb-4 sm:mb-6 tracking-tight leading-[1.1]">
              ...
              <span className="block font-normal mt-1 sm:mt-2">Résultat showroom</span>
            </h1>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-slate-600 mb-8 sm:mb-12 font-light leading-relaxed px-4 sm:px-0">
              ...
              <span className="block mt-2 text-sm sm:text-base text-slate-400">Intérieur + Extérieur + Protection • Dès 120€</span>
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
            ...
            <article className="bg-slate-50 p-6 sm:p-8 rounded-2xl border border-slate-100">
              ...
              <div className="mb-6 sm:mb-8 pb-6 sm:pb-8 border-b border-slate-200">
                <div className="text-4xl sm:text-5xl font-light text-slate-900 mb-1">120€</div>
              </div>
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un nettoyage complet à Herve - 120€"
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-slate-900 mb-4 sm:mb-6 leading-tight">
              Réservez votre nettoyage complet
            </h2>
      ...
      <footer className="py-12 sm:py-16 border-t border-slate-100 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
            ...
            <div>
              <h4 className="font-medium text-slate-900 mb-3 sm:mb-4 text-sm sm:text-base">Services</h4>
              <ul className="space-y-2 text-xs sm:text-sm">
                <li><Link href="/nettoyage-interieur-voiture" className="text-slate-600 hover:text-slate-900 transition-colors">Complet</Link></li>
                <li><Link href="/nettoyage-exterieur-voiture" className="text-slate-600 hover:text-slate-900 transition-colors">Extérieur</Link></li>
                <li><Link href="/nettoyage-complet-voiture" className="text-slate-600 hover:text-slate-900 transition-colors">Complet</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="font-medium text-slate-900 mb-3 sm:mb-4 text-sm sm:text-base">Zones</h4>
              <ul className="space-y-2 text-xs sm:text-sm">
                <li><Link href="/nettoyage-voiture-herve" className="text-slate-600 hover:text-slate-900 transition-colors">Herve</Link></li>
                <li><Link href="/nettoyage-voiture-verviers" className="text-slate-600 hover:text-slate-900 transition-colors">Verviers</Link></li>
                <li><Link href="/lavage-voiture-liege" className="text-slate-600 hover:text-slate-900 transition-colors">Liège</Link></li>
              </ul>
            </div>
          ...
          <div className="pt-6 sm:pt-8 border-t border-slate-100 text-center">
            <div className="text-xs sm:text-sm text-slate-500">
              © 2025 Shine&Go. Nettoyage complet voiture.
            </div>
          </div>
        </div>
      </footer>
