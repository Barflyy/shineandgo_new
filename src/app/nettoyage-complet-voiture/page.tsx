        ...
        <div className="container mx-auto px-6 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-8 sm:mb-12 font-light leading-relaxed px-4 sm:px-0">
              ...
              <span className="block mt-2 text-sm sm:text-base text-gray-400">Intérieur + Extérieur + Protection • Dès 120€</span>
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
            ...
            <article className="bg-gray-50 p-6 sm:p-8 rounded-2xl border border-gray-100">
              ...
              <div className="mb-6 sm:mb-8 pb-6 sm:pb-8 border-b border-gray-200">
                <div className="text-4xl sm:text-5xl font-light text-gray-900 mb-1">120€</div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs sm:text-sm">
                <li><Link href="/nettoyage-interieur-voiture" className="text-gray-600 hover:text-gray-900 transition-colors">Complet</Link></li>
