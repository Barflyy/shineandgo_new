...
export default function VerviersClientComponent() {
  // --- ÉTATS GLOBAUX ---
  ...
  const handleBooking = () => {
    try {
      window.open('https://wa.me/32472303701?text=Bonjour,%20je%20souhaite%20r%C3%A9server%20un%20nettoyage%20voiture%20%C3%A0%20Verviers', '_blank', 'noopener,noreferrer');
    } catch (error) {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Oui, nous intervenons dans toute la région de Verviers et alentours (Dison, Pepinster, Jalhay, Spa) avec un déplacement gratuit jusqu'à 25 km. Au-delà, un supplément peut s'appliquer selon la distance. Contactez-nous pour vérifier la disponibilité dans votre zone."
    },
    {
          ...
          <div className="relative min-h-screen flex items-center justify-center bg-white">
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="https://wa.me/32472303701?text=Bonjour,%20je%20souhaite%20un%20devis%20gratuit%20pour%20un%20nettoyage%20voiture%20%C3%A0%20Verviers"
                  target="_blank"
                  rel="noopener noreferrer"
