    ...
    <section className="relative py-12 sm:py-16 md:py-24 lg:py-32 bg-white overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {faqs.map((faq, idx) => (
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-between gap-3 sm:gap-4 p-4 sm:p-5 md:p-6 text-left transition-colors touch-manipulation min-h-[56px]"
              >
                <span className="text-sm sm:text-base md:text-lg font-semibold text-dark-900 group-hover:text-brand-600 transition-colors pr-2">
                  {faq.question}
                </span>
                <ChevronDown 
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <p className="text-dark-600 mb-4 sm:mb-6 text-sm sm:text-base">Vous ne trouvez pas la réponse à votre question ?</p>
          <a
            href="https://wa.me/32472303701"
            className="inline-flex items-center gap-2 px-6 sm:px-8 py-4 rounded-xl bg-gradient-to-r from-brand-500 to-brand-600 text-white font-bold text-base sm:text-lg shadow-glow active:scale-95 sm:hover:scale-105 transition-all duration-300 touch-manipulation min-h-[56px]"
          >
