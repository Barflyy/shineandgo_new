...
export default function ModernProcess() {
  ...
  return (
    <section className="relative py-12 md:py-16 lg:py-24 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-12 lg:mb-16">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl text-white/90 text-xs sm:text-sm font-semibold mb-4 sm:mb-6">
          ...
          <p className="text-sm sm:text-base md:text-lg text-white/70 max-w-2xl mx-auto px-4 leading-relaxed">
          ...
          {steps.map((step, idx) => {
            ...
            return (
              <div key={step.number} className="relative">
                ...
                <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-16 items-center mb-8 md:mb-12 lg:mb-16 last:mb-0">
                  ...
                  <div className={`${idx % 2 === 0 ? 'lg:order-1' : 'lg:order-2'}`}>
                    <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 md:gap-6">
                      {/* Icon */}
                      <div className={`flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-xl sm:rounded-2xl md:rounded-3xl bg-gradient-to-br ${step.color} p-1 shadow-glow`}>
                        <div className="w-full h-full rounded-xl sm:rounded-2xl md:rounded-3xl bg-dark-900 flex items-center justify-center">
                      ...
                      <div className="flex-1">
                        <div className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-br ${step.color} bg-clip-text text-transparent mb-2 sm:mb-3 md:mb-4`}>
                          {step.number}
                        </div>
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-1.5 sm:mb-2 md:mb-3">{step.title}</h3>
        ...
        <div className="mt-12 md:mt-16 lg:mt-20 text-center px-4">
          <div className="inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-4 p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10">
            <div className="text-center sm:text-left">
              <div className="text-white font-semibold text-sm sm:text-base mb-1">Prêt à commencer ?</div>
              <div className="text-white/60 text-xs sm:text-sm">Réservez votre créneau en moins de 2 minutes</div>
            </div>
            <a
              href="https://wa.me/32472303701"
              className="group px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-gradient-to-r from-brand-500 to-brand-600 text-white font-semibold text-sm sm:text-base shadow-glow hover:shadow-glow-lg transition-all duration-300 hover:scale-105 flex items-center gap-2 touch-manipulation"
            >
