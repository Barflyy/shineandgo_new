  ...
  return (
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950">
        {/* Animated orbs */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-brand-500/30 to-purple-500/30 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-cyan-500/20 to-blue-500/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Urgency badge */}
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 mb-8 animate-pulse">
            <div className="relative flex h-2.5 w-2.5">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-orange-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-orange-500"></span>
            </div>
            <Calendar className="w-4 h-4 text-white" />
            <span className="text-sm font-bold text-white">Seulement 5 créneaux disponibles cette semaine</span>
          </div>

          {/* Main CTA headline */}
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold text-white mb-6 leading-[1.1]">
          ...
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-12 leading-relaxed">
            ...
            <span className="block mt-2 text-lg text-white/60">
              🚗 Intérieur + Extérieur · ✨ Finition Showroom · ⚡ En 90 minutes
            </span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 mb-12">
            ...
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 px-10 py-6 rounded-2xl bg-white/10 backdrop-blur-2xl border-2 border-white/30 text-white font-bold text-lg hover:bg-white/20 hover:border-white/40 transition-all duration-300"
            >
