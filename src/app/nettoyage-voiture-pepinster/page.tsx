...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-pepinster.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Pepinster : intérieur & extérieur | Shine&Go",
      description: "Lavage et nettoyage voiture à domicile à Pepinster. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-pepinster.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function PepinsterPage() {
  ...
  const structuredData = generateCityStructuredData('pepinster', 'Pepinster', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Pepinster", url: "https://www.shineandgo.be/nettoyage-voiture-pepinster" },
    },
    faqs: [
      {
