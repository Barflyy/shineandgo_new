...
function HeroSection() {
    const handleBooking = () => { window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage voiture à Hermalle. 🚗', '_blank'); };
                ...
                <div className="max-w-3xl mx-auto">
                    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} className="flex justify-center mb-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200/80 shadow-sm">
                            ...
                            <span className="text-xs font-semibold text-slate-700">Déplacement gratuit à Hermalle</span>
                        </div>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }} className="text-center mb-6">
                        <h1 className="font-display text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-4">
                            ...
                            <span className="relative inline-block">
                                <span className="relative z-10 bg-gradient-to-r from-sky-500 to-emerald-500 bg-clip-text text-transparent">à Hermalle</span>
                        ...
                        <p className="text-lg sm:text-xl text-slate-600 max-w-xl mx-auto leading-relaxed">
                            Valeting premium en <strong className="text-slate-900">Basse-Meuse</strong>. Navetteur vers Maastricht ? On s'occupe de votre voiture pendant que vous travaillez.
                        </p>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="flex flex-col gap-3 mb-8">
                        ...
                        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handleBooking} className="w-full sm:w-auto sm:mx-auto group relative overflow-hidden px-8 py-5 bg-slate-900 text-white font-bold text-lg rounded-2xl shadow-2xl shadow-slate-900/25 transition-all duration-300">
                            <span className="relative z-10 flex items-center justify-center gap-3"><CalendarCheck className="w-5 h-5" /> Réserver à Hermalle <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" /></span>
...
function BenefitsSection() {
    const benefits = [
        { icon: Car, title: "Spécial navetteurs", description: "Travaillez à Maastricht ou Liège ? Votre voiture vous attend propre à votre retour.", color: "sky" },
        { icon: Droplets, title: "Sel & humidité Meuse", description: "L'humidité de la Meuse et le sel hivernal attaquent votre auto. On la protège.", color: "emerald" },
        { icon: Shield, title: "Couverture transfrontalière", description: "Hermalle, Visé, Oupeye, jusqu'à la frontière néerlandaise. Déplacement gratuit.", color: "violet" },
    ];
        ...
        <section className="py-16 sm:py-20 bg-white">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Pourquoi choisir Shine&Go à Hermalle ?</h2>
                </motion.div>
        ...
        <section id="services" className="py-16 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    ...
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-3">Tarifs lavage voiture à Hermalle</h2>
                    <p className="text-slate-600 max-w-md mx-auto">Tarifs transparents, déplacement gratuit à Hermalle et environs.</p>
                </motion.div>
...
function TestimonialsSection() {
    const testimonials = [
        { name: 'Jean-Marc V.', location: 'Hermalle', text: 'Je travaille à Maastricht, ils sont venus pendant ma journée de bureau. Retour = voiture impeccable !', avatar: '👨' },
        { name: 'Isabelle P.', location: 'Visé', text: 'L\'humidité de la Meuse avait terni ma peinture. Ils ont fait un travail remarquable.', avatar: '👩' },
        { name: 'Philippe D.', location: 'Oupeye', text: 'Après l\'hiver et tout le sel sur les routes, ma voiture revit. Traitement anti-corrosion top !', avatar: '👨' },
    ];
        ...
        <section className="py-16 sm:py-24 bg-white overflow-hidden">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    ...
                    <p className="text-slate-600">Ce que nos clients disent de nous à Hermalle</p>
                </motion.div>
...
function FAQSection() {
    const faqs = [
        { question: "Je travaille à Maastricht, vous pouvez venir pendant que je suis absent ?", answer: "C'est notre spécialité navetteurs ! On intervient pendant vos heures de bureau. Votre voiture sera prête à votre retour." },
        { question: "Traitez-vous les dégâts du sel hivernal ?", answer: "Oui ! On élimine le sel et les résidus corrosifs du châssis et de la carrosserie. Protection anti-corrosion disponible." },
        { question: "L'humidité de la Meuse abîme ma peinture, que faire ?", answer: "On applique une cire de protection longue durée qui repousse l'humidité et les polluants. Idéal pour la Basse-Meuse." },
        { question: "Vous allez jusqu'à la frontière néerlandaise ?", answer: "Oui ! Hermalle, Visé, Oupeye, Blegny... On couvre toute la zone frontalière. Déplacement gratuit." }
    ];
...
function CTASection() {
    const handleBooking = () => { window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage voiture à Hermalle. 🚗', '_blank'); };
    const zones = ['Visé', 'Oupeye', 'Liège', 'Herstal', 'Blegny'];
        ...
        <section className="relative py-16 sm:py-24 overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto px-5 text-center">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                    ...
                    <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">Prêt pour une voiture<br className="sm:hidden" /> comme neuve à Hermalle ?</h2>
                    ...
                    <div className="pt-8 border-t border-white/10">
                        <p className="text-sm text-white/50 mb-4 flex items-center justify-center gap-2"><MapPin className="w-4 h-4" /> Zones proches de Hermalle</p>
...
export default function HermalleClient() {
    return (
