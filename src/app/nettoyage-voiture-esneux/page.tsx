...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-esneux.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Esneux : intérieur & extérieur | Shine&Go",
      description: "Nettoyage auto mobile à Esneux : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-esneux.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function EsneuxPage() {
  ...
  const structuredData = generateCityStructuredData('esneux', 'Esneux', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Esneux", url: "https://www.shineandgo.be/nettoyage-voiture-esneux" },
    },
    faqs: [
      {
