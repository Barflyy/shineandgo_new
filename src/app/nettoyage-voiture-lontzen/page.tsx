...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage voiture Lontzen à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-lontzen.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Lontzen",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Lontzen : intérieur & extérieur | Shine&Go",
      description: "Lavage voiture Lontzen à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-lontzen.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function LontzenPage() {
  ...
  const structuredData = generateCityStructuredData('lontzen', 'Lontzen', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Lontzen",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Lontzen", url: "https://www.shineandgo.be/nettoyage-voiture-lontzen" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Lontzen ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="lontzen" 
        cityName="Lontzen"
        csvData={getCSVCityData('nettoyage-voiture-lontzen')}
      />
    </>
  );
}
