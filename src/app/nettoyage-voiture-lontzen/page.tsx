...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-lontzen",
    },
    openGraph: {
      title: "Lavage auto mobile à Lontzen : intérieur & extérieur | Shine&Go",
      description: "Lavage voiture Lontzen à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-lontzen.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Lontzen : intérieur & extérieur | Shine&Go",
      description: "Lavage voiture Lontzen à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-lontzen.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function LontzenPage() {
  ...
  const structuredData = generateCityStructuredData('lontzen', 'Lontzen', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Lontzen", url: "https://shineandgo.be/nettoyage-voiture-lontzen" },
    },
    faqs: [
      {
