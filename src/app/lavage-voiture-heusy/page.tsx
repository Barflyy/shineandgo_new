...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/lavage-voiture-heusy',
  },
  openGraph: {
    title: 'Lavage Voiture Heusy - Nettoyage à Domicile',
    description: 'Service de nettoyage auto à Heusy. Nous nous déplaçons chez vous. Lavage complet, soins des cuirs, traitement carrosserie. Qualité premium.',
    url: 'https://shineandgo.be/lavage-voiture-heusy',
    siteName: 'Shine&Go',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lavage voiture domicile Heusy Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
...
export default function HeusyPage() {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Combien coûte un lavage voiture à domicile à Heusy ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nos tarifs à Heusy démarrent à 65€ pour un lavage intérieur, 50€ pour l'extérieur, et 100€ pour la formule complète. Le déplacement est inclus."
        }
      },
      {
        "@type": "Question",
        "name": "Intervenez-vous à Heusy pour le lavage voiture ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Oui, nous intervenons à Heusy et dans toutes les communes environnantes. Réservez en ligne ou par téléphone."
        }
      },
      {
        "@type": "Question",
        "name": "Quels services de lavage proposez-vous à Heusy ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nous proposons le lavage intérieur, extérieur et complet à Heusy. Nous utilisons des produits professionnels Koch-Chemie."
        }
      }
    ]
  }
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 mb-8 px-4 py-2 bg-blue-50 dark:bg-blue-500/10 border border-transparent dark:border-blue-500/20 rounded-full animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              ...
              <span className="text-sm font-medium text-blue-900 dark:text-blue-300">Service Premium</span>
            </div>
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 dark:text-white mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Heusy : Votre service mobile de lavage auto premium</h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Lavage voiture professionnel directement chez vous à Heusy. Profitez d'un service premium avec les meilleurs produits du marché.
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <a
                href="https://wa.me/32472303701?text=Bonjour, je souhaite réserver un nettoyage voiture à Heusy"
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-gray-500 dark:text-gray-400 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              <span className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Produits professionnels</span>
              <span className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Lavage main complet</span>
              <span className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Service à domicile</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage auto à <span className="font-semibold">Heusy</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed text-pretty">
              Votre voiture mérite le meilleur traitement. Shine&Go se déplace partout à Heusy pour un nettoyage intérieur et extérieur de qualité. Nous couvrons l'ensemble des codes postaux de Heusy, apportant notre savoir-faire de detailer professionnel directement dans votre garage ou sur votre allée.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group p-8 bg-gradient-to-br from-orange-50 to-white rounded-2xl border border-orange-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center">
                ...
                <p className="text-sm text-gray-600 text-pretty">Nous venons à Heusy quand cela vous arrange, à domicile ou au bureau</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto items-start">
            ...
            <article className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 h-full">
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un nettoyage intérieur à Heusy - 65€"
            ...
            <article className="relative group bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-2xl hover:shadow-blue-900/20 hover:-translate-y-1 transition-all duration-300 md:-mt-4 md:mb-4 z-10">
              ...
              <div className="mb-8">
                ...
                <p className="text-slate-400 text-sm">La formule parfaite</p>
              </div>
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite le nettoyage complet à Heusy - 120€"
            ...
            <article className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 h-full">
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un lavage extérieur à Heusy - 85€"
                className="block w-full py-4 border border-gray-200 text-gray-900 font-medium rounded-xl text-center hover:bg-gray-50 hover:border-gray-300 transition-all"
              >
                Réserver
              </a>
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Lavage voiture Heusy`}
                      fill
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
              <a
                href="https://www.google.com/search?q=shine+and+go+heusy"
                target="_blank"
                rel="noopener noreferrer"
...
<section className="py-16 sm:py-20 md:py-32 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-12">
              Réservez votre lavage à domicile avec Shine&Go.
            </p>
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        "@context": "https://schema.org",
        "@type": "AutoWash",
        "name": "Shine&Go - Lavage voiture Heusy",
        "description": "Service de nettoyage et detailing automobile à domicile à Heusy.",
        "url": "https://shineandgo.be/lavage-voiture-heusy",
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Heusy",
                "item": "https://shineandgo.be/lavage-voiture-heusy"
            }
        ,
    {
        "@context": "https://schema.org",
