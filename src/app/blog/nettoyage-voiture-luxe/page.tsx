...
export default function ArticlePage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Nettoyage Voiture de Luxe : Notre Service Premium",
        "author": {
          "@type": "Organization",
          "name": "Shine & Go"
        },
    ...
    <main className="bg-white min-h-screen font-sans">
      ...
      <Breadcrumbs 
        items={[
          ...
          { label: 'Nettoyage Voiture de Luxe' }
        ]} 
      />
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <header className="mb-12">
          ...
          <div className="flex flex-wrap gap-4 items-center text-sm text-gray-500 mb-6 font-medium">
            <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full font-medium">Premium</span>
            <span className="flex items-center gap-1"><Calendar className="w-4 h-4" /> 20 Mai 2024</span>
        ...
        <div className="prose prose-lg prose-blue max-w-none text-gray-700">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <Sparkles className="text-blue-600" /> Produits pH Neutre
            </h2>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <Sparkles className="text-blue-600" /> Technique des 2 Seaux
            </h2>
