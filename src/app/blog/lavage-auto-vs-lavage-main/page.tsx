      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <header className="mb-12 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-4 items-center text-sm text-gray-500 mb-6 justify-center md:justify-start">
            ...
            <span className="flex items-center gap-1"><Calendar className="w-4 h-4" /> 22 Mar 2024</span>
        ...
        <div className="prose prose-lg prose-blue max-w-none text-gray-700">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Les Rouleaux (Portique Automatique)</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Le Jet Haute Pression (Karcher)</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Le Lavage à la Main (Technique des 2 seaux)</h2>
