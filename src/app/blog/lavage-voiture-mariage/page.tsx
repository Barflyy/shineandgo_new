...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'article',
    publishedTime: '2024-Mai-15', // Approx date conv
    authors: ['Shine&Go'],
  }
}
...
export default function ArticlePage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Lavage Voiture pour Mariage : Brillance Garantie Jour J",
        "author": {
          "@type": "Organization",
          "name": "Shine & Go"
        },
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Pouvez-vous décorer la voiture ?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Nous nous occupons du nettoyage. La décoration (rubans, fleurs) se pose sur une voiture propre, nous pouvons conseiller votre fleuriste."
            }
          }
        ]
      }
    ...
    <main className="bg-white min-h-screen font-sans">
      ...
      <Breadcrumbs 
        items={[
          ...
          { label: 'Lavage Voiture pour Mariage ' }
        ]} 
      />
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <header className="mb-12 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-4 items-center text-sm text-gray-500 mb-6 justify-center md:justify-start">
            <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full font-medium">Événement</span>
            <span className="flex items-center gap-1"><Calendar className="w-4 h-4" /> 15 Mai 2024</span>
            <span className="flex items-center gap-1"><Clock className="w-4 h-4" /> 4 min de lecture</span>
          </div>

          <h1 className="text-4xl md:text-5xl md:leading-tight font-bold text-gray-900 mb-8 text-balance">
            Lavage Voiture pour Mariage : Brillance Garantie Jour J
          </h1>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-xl">
            <p className="text-xl text-blue-900 italic">
              "La robe est prête, le costume aussi. Et le carrosse ? La voiture sera sur toutes les photos. Elle ne peut pas avoir de moustiques sur le pare-chocs."
            </p>
          </div>
        </header>
        ...
        <div className="prose prose-lg prose-blue max-w-none text-gray-700">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Brillance Maximale</h2>
            <div dangerouslySetInnerHTML={{ __html: `Nous utilisons des cires carnauba ou des lustrants rapides (Quick Detailer) juste avant l'événement pour un effet miroir profond.` }} />
          </section>
          

          <section className="mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Intérieur Compatible Robe Blanche</h2>
            <div dangerouslySetInnerHTML={{ __html: `L'intérieur doit être immaculé. Aucune trace de gras ne doit risquer de tacher la robe de la mariée. Seuils de portes ultra-propres garantis.` }} />
          </section>
          ...
          <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 my-12">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Conclusion</h3>
             <div dangerouslySetInnerHTML={{ __html: `Réservez votre créneau la veille du mariage pour éviter le stress.` }} />
          </div>
          ...
          <div className="space-y-6">
            ...
            <details className="group bg-white border border-gray-200 rounded-xl p-4 cursor-pointer">
              <summary className="font-medium text-gray-900 flex justify-between items-center">
                Pouvez-vous décorer la voiture ?
              ...
              <div className="mt-4 text-gray-600 pl-4 border-l-2 border-blue-100">
                Nous nous occupons du nettoyage. La décoration (rubans, fleurs) se pose sur une voiture propre, nous pouvons conseiller votre fleuriste.
              </div>
            </details>
