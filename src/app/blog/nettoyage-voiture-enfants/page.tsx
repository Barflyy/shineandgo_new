...
export const metadata: Metadata = {
  title: `Lavage Voiture avec Enfants : Miettes, Taches, Odeurs | Shine&Go`,
...
export default function ArticlePage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Lavage Voiture avec Enfants : Miettes, Taches, Odeurs",
        "author": {
          "@type": "Organization",
          "name": "Shine & Go"
        },
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        ...
        <header className="mb-12">
          ...
          <div className="flex flex-wrap gap-4 items-center text-sm text-gray-500 mb-6 font-medium">
            ...
            <span className="meta-text flex items-center gap-2"><Calendar className="w-4 h-4" /> 30 Juin 2025</span>
