  ...
  return (
    <main className="bg-white min-h-screen font-sans">
      <script
        ...
        "address": {
            "@type": "PostalAddress",
            "addressLocality": "Express 30 minutes",
            "addressRegion": "Liège",
            "addressCountry": "BE"
        },
        "geo": {
        ...
        <header className="mb-12">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-8 rounded-r-3xl mb-12">
            <p className="text-xl text-blue-900 italic font-medium leading-relaxed">
              "Le service de nettoyage voiture express : l'essentiel en 30 minutes est essentiel pour maintenir votre véhicule en bon état."
            </p>
          </div>
        </header>
