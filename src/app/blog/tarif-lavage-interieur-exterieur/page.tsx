...
export default function ArticlePage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Tarif Lavage Intérieur + Extérieur : À Quoi S'attendre",
        "author": {
          "@type": "Organization",
          "name": "Shine & Go"
        },
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        ...
        <header className="mb-12">
          ...
          <h1 className="article-title mb-8">
            Tarif Lavage Intérieur + Extérieur : À Quoi S'attendre
          </h1>

          <div className="quote-box">
            <p className="quote-text">
              "Le service de tarif lavage intérieur + extérieur : à quoi s'attendre est essentiel pour maintenir votre véhicule en bon état."
            </p>
          </div>
        </header>
