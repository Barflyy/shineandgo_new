...
export default function ArticlePage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Lavage Voiture Propriétaire d'Animaux (Poils + Odeurs)",
        "author": {
          "@type": "Organization",
          "name": "Shine & Go"
        },
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Utilisez-vous des produits dangereux pour les animaux ?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Non, nos produits sont safe une fois secs. Nous aérons toujours la voiture après intervention."
            }
          }
        ]
      }
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        ...
        <header className="mb-12 text-center md:text-left">
          ...
          <h1 className="article-title mb-8">
            Lavage Voiture Propriétaire d'Animaux (Poils + Odeurs)
          </h1>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-xl">
            <p className="text-xl text-blue-900 italic">
              "On les aime, mais ils ravagent nos intérieurs. Les poils s'incrustent, la bave tache les vitres, et l'odeur de 'chien mouillé' s'installe."
            </p>
          </div>
        </header>
        ...
        <div className="prose-shineandgo">
          ...
          <section className="mb-12">
            <h2>Désinfection Bactérienne</h2>
