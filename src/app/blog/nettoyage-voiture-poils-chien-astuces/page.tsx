    ...
    "@graph": [
      {
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://shineandgo.be/blog/nettoyage-voiture-poils-chien-astuces"
        }
      },
      {
        "@type": "FAQPage",
        ...
        <header className="mb-16">
          ...
          <div className="flex flex-wrap gap-4 items-center text-sm mb-8">
            ...
            <span className="flex items-center gap-2 text-gray-500 font-medium">
              <Calendar className="w-4 h-4 text-blue-500" /> 22 Mai 2024
            </span>
            <span className="flex items-center gap-2 text-gray-500 font-medium">
        ...
        <div className="prose prose-xl prose-blue max-w-none text-gray-700 leading-relaxed font-light">
          ...
          <section className="mb-20">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-8 flex items-center gap-4">
              <Sparkles className="text-blue-600 w-8 h-8 flex-shrink-0" /> Le matériel indispensable
            </h2>
            <p className="text-xl leading-relaxed">Pour retirer les poils les plus tenaces, les detailers utilisent des brosses en caoutchouc spéciales ou des pierres ponces synthétiques. En frottant doucement, les poils se regroupent en petits tas faciles à aspirer. L'utilisation d'un compresseur à air (Torunador) permet aussi de déloger les poils coincés sous les rails de sièges.</p>
          </section>

          <section className="mb-20">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-8 flex items-center gap-4">
              <Sparkles className="text-blue-600 w-8 h-8 flex-shrink-0" /> La méthode Shine&Go
            </h2>
            <p className="text-xl leading-relaxed">Nos experts à domicile ne se contentent pas de brosser. Nous utilisons l'électricité statique et des aspirateurs à haute dépression. Nous traitons ensuite l'habitacle pour éliminer l'odeur de chien mouillé souvent associée à la présence d'animaux, pour un intérieur sain comme au premier jour.</p>
          </section>
          ...
          <div className="bg-gray-50 rounded-[2.5rem] p-10 border border-gray-100 mb-24 font-sans">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <RelatedLink href="/blog/nettoyage-voiture-avant-vente" title="Nettoyage Avant Vente" /><RelatedLink href="/blog/lavage-voiture-fumeur" title="Traitement Fumeur" /><RelatedLink href="/blog/nettoyage-siege-tissu-tache" title="Nettoyage Sièges Tissu" /><RelatedLink href="/blog/combien-coute-lavage-voiture-domicile" title="Prix Lavage Domicile" />
            </div>
          </div>
