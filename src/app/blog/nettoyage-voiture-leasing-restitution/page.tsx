...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'article',
    publishedTime: '2025-Avr-25', // Approx date conv
    authors: ['Shine&Go'],
  }
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([{
            ...
            "url": "https://shineandgo.be/lavage-voiture-leasing-restitution",
          ...
          },
          {
            ...
            "item": "https://shineandgo.be/lavage-voiture-leasing-restitution"
          }])
        }}
      />
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        ...
        <header className="mb-12 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-4 items-center text-sm text-gray-500 mb-6 justify-center md:justify-start">
            ...
            <span className="meta-text flex items-center gap-2"><Calendar className="w-4 h-4" /> 25 Avr 2025</span>
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
            Lavage voiture complet avant restitution leasing</h1>
