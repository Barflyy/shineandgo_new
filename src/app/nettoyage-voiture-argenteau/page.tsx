...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage et nettoyage voiture à domicile à Argenteau. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-argenteau.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Argenteau",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Argenteau | Shine&Go (service premium)",
      description: "Lavage et nettoyage voiture à domicile à Argenteau. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-argenteau.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function ArgenteauPage() {
  ...
  const structuredData = generateCityStructuredData('argenteau', 'Argenteau', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Argenteau",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Argenteau", url: "https://www.shineandgo.be/nettoyage-voiture-argenteau" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Argenteau ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="argenteau" 
        cityName="Argenteau"
        csvData={getCSVCityData('nettoyage-voiture-argenteau')}
      />
    </>
  );
}
