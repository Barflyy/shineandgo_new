...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-argenteau.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Argenteau | Shine&Go (service premium)",
      description: "Lavage et nettoyage voiture à domicile à Argenteau. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-argenteau.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function ArgenteauPage() {
  ...
  const structuredData = generateCityStructuredData('argenteau', 'Argenteau', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Argenteau", url: "https://shineandgo.be/nettoyage-voiture-argenteau" },
    },
    faqs: [
      {
