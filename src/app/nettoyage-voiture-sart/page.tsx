        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Car Wash Mobile
              <span className="block font-semibold mt-2 text-gray-900">à Sart</span>
            </h1>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                ...
                { name: 'Tiège', href: '/nettoyage-voiture-jalhay' },
                { name: 'Solwaster', href: '/nettoyage-voiture-jalhay' },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Nettoyage Voiture à Domicile Sart",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Shine&Go",
            ...
            "description": "Service de nettoyage automobile à domicile à Sart-Jalhay. Lavage intérieur et extérieur, detailing, protection céramique.",
            "offers": {
              "@type": "Offer",
              "price": "65",
              "priceCurrency": "EUR"
