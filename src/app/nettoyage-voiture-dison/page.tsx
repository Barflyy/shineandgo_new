...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage voiture Dison à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-dison.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Dison",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Lavage voiture à Dison (Wallonie) | Shine&Go se déplace chez vous",
      description: "Lavage voiture Dison à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-dison.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function DisonPage() {
  ...
  const structuredData = generateCityStructuredData('dison', 'Dison', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Dison",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Dison", url: "https://www.shineandgo.be/nettoyage-voiture-dison" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Dison ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="dison" 
        cityName="Dison"
        csvData={getCSVCityData('nettoyage-voiture-dison')}
      />
    </>
  );
}
