...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-soumagne',
  },
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Soumagne - Intérieur & Extérieur',
    description: 'Expert du nettoyage véhicule à Soumagne. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Soumagne Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Soumagne",
                "item": "https://shineandgo.be/nettoyage-voiture-soumagne"
            }
        ,
    {
        "@context": "https://schema.org",
