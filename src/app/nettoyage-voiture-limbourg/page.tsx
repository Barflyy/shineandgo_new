...
export const metadata: Metadata = {
  title: 'Nettoyage Voiture à Domicile Limbourg - Intérieur & Extérieur',
  description: 'Expert du nettoyage véhicule à Limbourg. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-limbourg',
  },
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Limbourg - Intérieur & Extérieur',
    description: 'Expert du nettoyage véhicule à Limbourg. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
    url: 'https://shineandgo.be/nettoyage-voiture-limbourg',
    siteName: 'Shine&Go',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Limbourg Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Nettoyage voiture Limbourg`}
                      fill
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Limbourg",
                "item": "https://shineandgo.be/nettoyage-voiture-limbourg"
            }
        ]
    },
    {
