...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-limbourg.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Limbourg à domicile | Résultat showroom garanti",
      description: "Lavage voiture Limbourg à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-limbourg.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function LimbourgPage() {
  ...
  const structuredData = generateCityStructuredData('limbourg', 'Limbourg', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Limbourg", url: "https://shineandgo.be/nettoyage-voiture-limbourg" },
    },
    faqs: [
      {
