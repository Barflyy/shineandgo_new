...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-bolland',
  },
  openGraph: {
    title: 'Car Wash Domicile Bolland - Nettoyage Pro',
    description: 'Car Wash à domicile à Bolland. Lavage auto professionnel directement chez vous. Gain de temps, produits haut de gamme, résultat impeccable.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Bolland Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Bolland",
                "item": "https://shineandgo.be/nettoyage-voiture-bolland"
            }
        ,
    {
        "@context": "https://schema.org",
