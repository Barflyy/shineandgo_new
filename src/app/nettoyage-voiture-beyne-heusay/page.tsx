...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-beyne-heusay',
  },
  openGraph: {
    title: 'Nettoyage Voiture Beyne-Heusay - Lavage à Domicile',
    description: 'Lavage auto professionnel à Beyne-Heusay. Service mobile : nous venons chez vous. Nettoyage intérieur et extérieur de haute qualité. Devis gratuit.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Beyne-Heusay Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Lavage Auto
              <span className="block font-semibold mt-2 text-gray-900">à Beyne-Heusay</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Le spécialiste du nettoyage auto qui se déplace chez vous à Beyne-Heusay.
              <span className="block mt-2 text-base text-gray-400 font-normal">Sans attente • Résultat Pro • Déplacement gratuit</span>
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-gray-500 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              ...
              <span className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-600" /> Produits respectueux</span>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                ...
                { name: 'Bellaire', href: '/nettoyage-voiture-beyne-heusay' },
                { name: 'Queue-du-Bois', href: '/nettoyage-voiture-beyne-heusay' },
                { name: 'Grivegnée', href: '/nettoyage-voiture-liege' },
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-gray-900 mb-4 sm:mb-6 leading-tight">
              Beyne-Heusay,
              <span className="block">votre voiture étincelante</span>
            </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Nettoyage Voiture à Domicile Beyne-Heusay",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Shine&Go",
            ...
            "description": "Service de nettoyage automobile à domicile à Beyne-Heusay. Lavage intérieur et extérieur, detailing, protection céramique.",
            "offers": {
              "@type": "Offer",
              "price": "65",
              "priceCurrency": "EUR"
