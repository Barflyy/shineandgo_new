...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-thimister',
  },
  openGraph: {
    title: 'Nettoyage Voiture Thimister - Lavage Auto à Domicile',
    description: 'Service de lavage auto mobile à Thimister-Clermont. Nous venons chez vous pour un nettoyage complet. Intérieur, extérieur, simonisation. Devis gratuit.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Thimister Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Esthétique automobile et lavage à domicile à Thimister</h1>
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Thimister",
                "item": "https://shineandgo.be/nettoyage-voiture-thimister"
            }
        ,
    {
        "@context": "https://schema.org",
