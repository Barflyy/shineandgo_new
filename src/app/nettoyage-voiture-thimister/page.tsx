...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage voiture Thimister à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-thimister.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Thimister",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Thimister à domicile | Résultat showroom garanti",
      description: "Lavage voiture Thimister à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-thimister.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function ThimisterPage() {
  ...
  const structuredData = generateCityStructuredData('thimister', 'Thimister', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Thimister",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Thimister", url: "https://www.shineandgo.be/nettoyage-voiture-thimister" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Thimister ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="thimister" 
        cityName="Thimister"
        csvData={getCSVCityData('nettoyage-voiture-thimister')}
      />
    </>
  );
}
