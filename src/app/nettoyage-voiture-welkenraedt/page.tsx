...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-welkenraedt",
    },
    openGraph: {
      title: "Lavage auto mobile à Welkenraedt : intérieur & extérieur | Shine&Go",
      description: "Besoin d’un car wash à domicile à Welkenraedt ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-welkenraedt.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Welkenraedt : intérieur & extérieur | Shine&Go",
      description: "Besoin d’un car wash à domicile à Welkenraedt ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-welkenraedt.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function WelkenraedtPage() {
  ...
  const structuredData = generateCityStructuredData('welkenraedt', 'Welkenraedt', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Welkenraedt", url: "https://shineandgo.be/nettoyage-voiture-welkenraedt" },
    },
    faqs: [
      {
