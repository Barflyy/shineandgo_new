...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Besoin d’un car wash à domicile à Welkenraedt ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-welkenraedt.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Welkenraedt",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Welkenraedt : intérieur & extérieur | Shine&Go",
      description: "Besoin d’un car wash à domicile à Welkenraedt ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-welkenraedt.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function WelkenraedtPage() {
  ...
  const structuredData = generateCityStructuredData('welkenraedt', 'Welkenraedt', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Welkenraedt",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Welkenraedt", url: "https://www.shineandgo.be/nettoyage-voiture-welkenraedt" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Welkenraedt ?",
  ...
  return (
    <>
      ...
      />
      <CityPageTemplateNew 
        citySlug="welkenraedt" 
        cityName="Welkenraedt"
        csvData={getCSVCityData('nettoyage-voiture-welkenraedt')}
      />
    </>
  );
}
