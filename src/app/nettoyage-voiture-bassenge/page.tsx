...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-bassenge',
  },
  openGraph: {
    title: 'Car Wash Mobile Bassenge - Nettoyage à Domicile',
    description: 'Lavage voiture à domicile à Bassenge et environs. Plus besoin de vous déplacer. Nettoyage intérieur/extérieur professionnel. Tarifs clairs et déplacement gratuit.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Bassenge Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Car Wash Mobile
              <span className="block font-semibold mt-2 text-gray-900">à Bassenge</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Un service de nettoyage auto unique qui vient jusqu'à vous à Bassenge.
              <span className="block mt-2 text-base text-gray-400 font-normal">Confort • Qualité • Simplicité</span>
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-gray-500 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              ...
              <span className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-600" /> Pas de frais cachés</span>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                { name: 'Roclenge', href: '/nettoyage-voiture-bassenge' },
                { name: 'Wonck', href: '/nettoyage-voiture-bassenge' },
                { name: 'Eben-Emael', href: '/nettoyage-voiture-bassenge' },
                { name: 'Glons', href: '/nettoyage-voiture-bassenge' },
                { name: 'Visé', href: '/nettoyage-voiture-vise' },
                { name: 'Houtain', href: '/nettoyage-voiture-oupeye' },
              ].map((city) => (
                <Link
                  key={city.name}
                  href={city.href}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-gray-900 mb-4 sm:mb-6 leading-tight">
              Bassenge,
              <span className="block">donnez une seconde jeunesse à votre auto</span>
            </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Nettoyage Voiture à Domicile Bassenge",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Shine&Go",
            ...
            "description": "Service de nettoyage automobile à domicile à Bassenge. Lavage intérieur et extérieur, detailing, protection céramique.",
            "offers": {
              "@type": "Offer",
              "price": "65",
              "priceCurrency": "EUR"
