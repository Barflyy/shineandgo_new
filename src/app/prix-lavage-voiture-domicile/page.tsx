        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="page-title animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Prix Lavage Voiture & <span className="page-title-accent">Lavage Auto</span>
            </h1>

            <p className="page-description px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto mb-8" style={{ animationDelay: '0.3s' }}>
              Découvrez nos tarifs pour le lavage de voiture à domicile. Des prix transparents pour un service de nettoyage auto et car wash mobile professionnel partout en province de Liège.
              <span className="block mt-2 text-base text-gray-400 font-normal">Lavage à la main • Déplacement gratuit • Dès 65€</span>
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="relative bg-gray-900 p-8 rounded-3xl border border-gray-800 hover:shadow-2xl hover:shadow-gray-900/20 hover:-translate-y-1 transition-all duration-300 flex flex-col shadow-2xl md:scale-105 md:z-10">
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-medium text-white mb-2">Lavage Complet</h2>
