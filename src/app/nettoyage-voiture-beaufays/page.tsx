...
export default function BeaufaysPage() {
  ...
  const structuredData = generateCityStructuredData('beaufays', 'Beaufays', {
    ...
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Beaufays ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="beaufays" 
        cityName="Beaufays"
        csvData={getCSVCityData('nettoyage-voiture-beaufays')}
      />
    </>
  );
}
