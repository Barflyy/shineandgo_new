...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-remicourt",
    },
    openGraph: {
      title: "Nettoyage voiture Remicourt à domicile | Résultat showroom garanti",
      description: "Lavage et nettoyage voiture à domicile à Remicourt. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-remicourt.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Remicourt à domicile | Résultat showroom garanti",
      description: "Lavage et nettoyage voiture à domicile à Remicourt. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-remicourt.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function RemicourtPage() {
  ...
  const structuredData = generateCityStructuredData('remicourt', 'Remicourt', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Remicourt", url: "https://shineandgo.be/nettoyage-voiture-remicourt" },
    },
    faqs: [
      {
