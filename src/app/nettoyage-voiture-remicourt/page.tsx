...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage et nettoyage voiture à domicile à Remicourt. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-remicourt.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Remicourt",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Remicourt à domicile | Résultat showroom garanti",
      description: "Lavage et nettoyage voiture à domicile à Remicourt. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-remicourt.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function RemicourtPage() {
  ...
  const structuredData = generateCityStructuredData('remicourt', 'Remicourt', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Remicourt",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Remicourt", url: "https://www.shineandgo.be/nettoyage-voiture-remicourt" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Remicourt ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="remicourt" 
        cityName="Remicourt"
        csvData={getCSVCityData('nettoyage-voiture-remicourt')}
      />
    </>
  );
}
