...
export default function AywaillePage() {
  ...
  const structuredData = generateCityStructuredData('aywaille', 'Aywaille', {
    ...
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Aywaille ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="aywaille" 
        cityName="Aywaille"
        csvData={getCSVCityData('nettoyage-voiture-aywaille')}
      />
    </>
  );
}
