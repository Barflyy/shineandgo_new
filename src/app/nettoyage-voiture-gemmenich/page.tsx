...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-gemmenich.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Gemmenich à domicile | Résultat showroom garanti",
      description: "Nettoyage auto mobile à Gemmenich : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-gemmenich.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function GemmenichPage() {
  ...
  const structuredData = generateCityStructuredData('gemmenich', 'Gemmenich', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Gemmenich", url: "https://www.shineandgo.be/nettoyage-voiture-gemmenich" },
    },
    faqs: [
      {
