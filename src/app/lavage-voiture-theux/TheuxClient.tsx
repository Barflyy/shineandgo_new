...
function HeroSection() {
    const handleBooking = () => { window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage voiture à Theux. 🚗', '_blank'); };
                ...
                <div className="max-w-3xl mx-auto">
                    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} className="flex justify-center mb-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200/80 shadow-sm">
                            ...
                            <span className="text-xs font-semibold text-slate-700">Déplacement gratuit à Theux</span>
                        </div>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }} className="text-center mb-6">
                        <h1 className="font-display text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-4">
                            ...
                            <span className="relative inline-block">
                                <span className="relative z-10 bg-gradient-to-r from-sky-500 to-emerald-500 bg-clip-text text-transparent">à Theux</span>
                        ...
                        <p className="text-lg sm:text-xl text-slate-600 max-w-xl mx-auto leading-relaxed">
                            Valeting spécial <strong className="text-slate-900">balades nature</strong> au pays des Franchimontois. Boue, poils de chien, feuilles ? On remet votre véhicule à neuf.
                        </p>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="flex flex-col gap-3 mb-8">
                        ...
                        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handleBooking} className="w-full sm:w-auto sm:mx-auto group relative overflow-hidden px-8 py-5 bg-slate-900 text-white font-bold text-lg rounded-2xl shadow-2xl shadow-slate-900/25 transition-all duration-300">
                            <span className="relative z-10 flex items-center justify-center gap-3"><CalendarCheck className="w-5 h-5" /> Réserver à Theux <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" /></span>
...
function BenefitsSection() {
    const benefits = [
        { icon: Car, title: "Expert poils d'animaux", description: "Après une balade avec votre chien ? Aspiration spéciale et brosses dédiées pour éliminer chaque poil.", color: "sky" },
        { icon: Droplets, title: "Traitement boue & feuilles", description: "Les sentiers du Franchimont laissent des traces. On redonne l'éclat originel à votre véhicule.", color: "emerald" },
        { icon: Shield, title: "Protection nature", description: "Résine des sapins, pollen, traces d'oiseaux... On traite tous les désagréments forestiers.", color: "violet" },
    ];
        ...
        <section className="py-16 sm:py-20 bg-white">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Pourquoi choisir Shine&Go à Theux ?</h2>
                </motion.div>
        ...
        <section id="services" className="py-16 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    ...
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-3">Tarifs lavage voiture à Theux</h2>
                    <p className="text-slate-600 max-w-md mx-auto">Tarifs transparents, déplacement gratuit à Theux et environs.</p>
                </motion.div>
...
function TestimonialsSection() {
    const testimonials = [
        { name: 'Sophie L.', location: 'Theux', text: 'Notre labrador laisse des poils partout. Aspiration spéciale et l\'intérieur sent le neuf !', avatar: '👩' },
        { name: 'Marc D.', location: 'Polleur', text: 'Randonnée aux Hautes Fagnes = voiture pleine de boue. Résultat showroom en 90 minutes !', avatar: '👨' },
        { name: 'Anne M.', location: 'La Reid', text: 'La résine de sapin avait envahi ma carrosserie. Traitement en douceur, peinture comme neuve.', avatar: '👩' },
    ];
        ...
        <section className="py-16 sm:py-24 bg-white overflow-hidden">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    ...
                    <p className="text-slate-600">Ce que nos clients disent de nous à Theux</p>
                </motion.div>
...
function FAQSection() {
    const faqs = [
        { question: "Ma voiture est pleine de poils de chien, c'est gérable ?", answer: "Notre spécialité ! Aspiration haute puissance, brosses anti-poils et désodorisant. Votre intérieur sera comme neuf." },
        { question: "J'ai de la boue des sentiers du Franchimont, ça part ?", answer: "Sans problème ! On traite la boue séchée en douceur avec nos produits pro. La carrosserie retrouve son éclat." },
        { question: "La résine de sapin a collé sur ma peinture...", answer: "On utilise des solvants spéciaux qui dissolvent la résine sans abîmer le vernis. Traitement en douceur garanti." },
        { question: "Venez-vous jusqu'à La Reid et Polleur ?", answer: "Oui ! On couvre tout le pays de Franchimont : Theux, Polleur, La Reid, Jehanster... Déplacement gratuit." }
    ];
...
function CTASection() {
    const handleBooking = () => { window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage voiture à Theux. 🚗', '_blank'); };
    const zones = ['Spa', 'Verviers', 'Herve', 'Malmedy', 'Liège'];
        ...
        <section className="relative py-16 sm:py-24 overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto px-5 text-center">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                    ...
                    <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">Prêt pour une voiture<br className="sm:hidden" /> comme neuve à Theux ?</h2>
                    ...
                    <div className="pt-8 border-t border-white/10">
                        <p className="text-sm text-white/50 mb-4 flex items-center justify-center gap-2"><MapPin className="w-4 h-4" /> Zones proches de Theux</p>
...
export default function TheuxClient() {
    return (
