...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-seraing',
  },
  openGraph: {
    title: 'Nettoyage Voiture Seraing - Lavage Mobile',
    description: 'Service de lavage auto mobile à Seraing. Shine&Go se déplace chez vous ou au bureau. Nettoyage complet, produits écologiques, devis immédiat.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Seraing Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 mb-8 px-4 py-2 bg-blue-50 rounded-full animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              ...
              <span className="text-sm font-medium text-blue-900">Service Client Top</span>
            </div>
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Lavage Voiture
              <span className="block font-semibold mt-2 text-gray-900">à Seraing</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Shine&Go à Seraing : le confort d'un nettoyage pro à domicile.
              <span className="block mt-2 text-base text-gray-400 font-normal">Rapide • Efficace • Tout inclus</span>
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <a
                href="https://wa.me/32472303701?text=Bonjour, je souhaite réserver un nettoyage voiture à Seraing"
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                ...
                { name: 'Ougrée', href: '/nettoyage-voiture-seraing' },
                { name: 'Boncelles', href: '/nettoyage-voiture-seraing' },
                { name: 'Liège', href: '/nettoyage-voiture-liege' },
                { name: 'Saint-Nicolas', href: '/nettoyage-voiture-saint-nicolas' },
                { name: 'Neupré', href: '/nettoyage-voiture-seraing' },
              ].map((city) => (
                <Link
                  key={city.name}
                  href={city.href}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto items-start">
            ...
            <article className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 h-full">
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un nettoyage intérieur à Seraing - 65€"
            ...
            <article className="relative group bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-2xl hover:shadow-blue-900/20 hover:-translate-y-1 transition-all duration-300 md:-mt-4 md:mb-4 z-10">
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite le nettoyage complet à Seraing - 120€"
            ...
            <article className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 h-full">
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un lavage extérieur à Seraing - 85€"
                className="block w-full py-4 border border-gray-200 text-gray-900 font-medium rounded-xl text-center hover:bg-gray-50 hover:border-gray-300 transition-all"
              >
                Réserver
              </a>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-gray-900 mb-4 sm:mb-6 leading-tight">
              Seraing,
              <span className="block">faites briller votre auto</span>
            </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Nettoyage Voiture à Domicile Seraing",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Shine&Go",
            ...
            "description": "Service de nettoyage automobile à domicile à Seraing. Lavage intérieur et extérieur, detailing, protection céramique.",
            "offers": {
              "@type": "Offer",
              "price": "65",
              "priceCurrency": "EUR"
