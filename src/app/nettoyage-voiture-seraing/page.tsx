...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-seraing.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Seraing : intérieur & extérieur | Shine&Go",
      description: "Besoin d’un car wash à domicile à Seraing ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-seraing.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function SeraingPage() {
  ...
  const structuredData = generateCityStructuredData('seraing', 'Seraing', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Seraing", url: "https://shineandgo.be/nettoyage-voiture-seraing" },
    },
    faqs: [
      {
