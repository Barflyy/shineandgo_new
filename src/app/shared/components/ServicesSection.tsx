...
import { Check, Sparkles, Car, Shield, Star, ArrowRight, Award, Zap, Clock, CheckCircle, Brush, MapPin } from 'lucide-react';
...
const services = [
  {
    ...
    price: "39",
    duration: "45 min",
    description: "Aspiration complète (sièges, moquettes, coffre). Nettoyage et protection des plastiques & tableau de bord. Traitement des vitres intérieures sans traces. Finition satinée et protection UV avec CarPro Perl.",
    features: [
      "Aspiration complète (sièges, moquettes, coffre)",
      "Nettoyage et protection des plastiques & tableau de bord",
      "Traitement des vitres intérieures sans traces",
      "Finition satinée et protection UV avec CarPro Perl"
    ],
    pricing: {
      "Citadine": 39,
      "Berline": 44,
  ...
  },
  {
    ...
    price: "79",
    duration: "90 min",
    description: "Tous les avantages du forfait Intérieur Fraîcheur. Prélavage à la mousse active décontaminante. Lavage manuel \"technique des deux seaux\" anti-rayures. Séchage et cire de protection hydrophobe (ProtectorWax Koch-Chemie).",
    features: [
      "Tous les avantages du forfait Intérieur Fraîcheur",
      "Prélavage à la mousse active décontaminante",
      "Lavage manuel \"technique des deux seaux\" anti-rayures",
      "Séchage et cire de protection hydrophobe (ProtectorWax Koch-Chemie)"
    ],
    pricing: {
      "Citadine": 79,
      "Berline": 89,
  ...
  },
  {
    ...
    price: "49",
    duration: "45 min",
    description: "Prélavage intensif à la mousse active. Lavage carrosserie, jantes et passages de roues. Nettoyage des seuils de porte. Protection cire express (ProtectorWax Koch-Chemie).",
    features: [
      "Prélavage intensif à la mousse active",
      "Lavage carrosserie, jantes et passages de roues",
      "Nettoyage des seuils de porte",
      "Protection cire express (ProtectorWax Koch-Chemie)"
    ],
    pricing: {
      "Citadine": 49,
      "Berline": 54,
  ...
  return (
    <section className="relative py-16 md:py-24 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-16 min-w-0 services-grid">
            ...
            <div key={index} className={`group relative ${service.popular ? 'lg:scale-105 lg:z-10' : ''}`}>
              ...
              `} style={{backgroundColor: 'white', opacity: 1}}>
                ...
                <div className="h-full flex flex-col p-4 sm:p-6 md:p-8">
                    ...
                    <h3 className="text-xl md:text-2xl font-black mb-3 leading-tight text-slate-900">
                      {service.name === "Intérieur Fraîcheur" ? (
                        <Link href="/nettoyage-interieur-voiture" className="hover:text-blue-600 transition-colors duration-200">
                          Nettoyage intérieur – Formule Fraîcheur
                        </Link>
                        ...
                        <Link href="/nettoyage-exterieur-voiture" className="hover:text-blue-600 transition-colors duration-200">
                          Nettoyage extérieur à la main – Formule Brillance
                        </Link>
                      ) : service.name}
                    </h3>
                  ...
                  {/* Clean CTA Button - Mobile Optimized */}
                  <button 
                    onClick={handleServiceBooking}
                    className={`
                      w-full py-4 px-6 rounded-xl font-semibold text-white text-base
                      transition-all duration-300 shadow-lg hover:shadow-xl min-h-[56px]
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-slate-700 font-medium">
                      <span className="font-semibold text-slate-900">Disponible à domicile dans un rayon de 25 km autour de Herve :</span> Verviers, Battice, Soumagne, Liège, etc.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 sm:p-8 md:p-12 shadow-lg">
              ...
              <h3 className="text-2xl md:text-3xl font-black text-slate-900 mb-4">
                <span className="text-blue-600">
                  Réservez votre lavage à domicile dès aujourd'hui
                </span>
              </h3>

              {/* CTA Description */}
              <p className="text-slate-600 mb-8 text-lg">
                Et recevez <span className="font-bold text-green-600">10 € de réduction</span> sur votre première prestation. Produits <span className="font-semibold text-slate-900">Koch Chemie</span> • <span className="font-semibold text-slate-900">CarPro Perl</span> • <span className="font-semibold text-blue-600">Résultat garanti</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <button 
                  ...
                  className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 sm:px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
                ...
                <button 
                  onClick={handleDevis}
                  className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-6 sm:px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
                    <span>💬 WhatsApp</span>
                    <ArrowRight className="w-5 h-5" />
                </button>
                ...
                <button 
                  onClick={handleDevis}
                  className="inline-flex items-center gap-2 border-2 border-blue-600 bg-transparent text-blue-600 hover:bg-blue-50 font-semibold px-6 sm:px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
