      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-8 text-center">
          <p className="text-slate-500 text-xs leading-relaxed max-w-4xl mx-auto">
            Shine&Go - Votre Spécialiste du Lavage Voiture à Domicile. Service premium de nettoyage auto et detailing mobile en Wallonie. 📞 0472 30 37 01 | ✉️ nathangodfroid@gmail.com | 💬 WhatsApp 7j/7
          </p>
        </div>
