...
export const metadata: Metadata = {
  title: 'Lavage Voiture Complet à Domicile | Intérieur & Extérieur - Shine&Go',
  description: 'Lavage voiture complet à domicile : intérieur + extérieur. Rénovation totale, soins tissus, cire protection. Service mobile à Herve, Verviers, Liège. Dès 120€.',
  alternates: {
    canonical: 'https://shineandgo.be/lavage-complet-voiture',
  },
  openGraph: {
    title: 'Lavage Voiture Complet à Domicile | Shine&Go',
    description: 'Lavage voiture complet professionnel à domicile : intérieur + extérieur. Dès 120€.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lavage voiture complet domicile - Shine&Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...
            },
            {
              ...
              "item": "https://shineandgo.be/lavage-complet-voiture"
            }
          ])
        }}
      />
