...
export const metadata: Metadata = {
  ...
  description: 'Lavage voiture à Fleron. Service mobile de qualité. Nous venons chez vous pour un lavage complet intérieur et extérieur. Devis gratuit.',
  alternates: {
      ...
      <section className="relative pt-16 pb-6 sm:pt-20 sm:pb-10 md:pt-28 md:pb-12 overflow-hidden bg-white dark:bg-slate-950">
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 dark:text-white mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>Lavage voiture professionnel à Fleron</h1>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage voiture à <span className="font-semibold">Fleron</span>
            </h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
              <a
                href="https://www.google.com/search?q=shine+and+go+fleron"
                target="_blank"
                rel="noopener noreferrer"
...
<section className="py-16 sm:py-20 md:py-32 bg-white">
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "@type": "AutoWash",
        "name": "Shine&Go - Lavage voiture Fleron",
        "description": "Service de nettoyage et detailing automobile à domicile à Fleron.",
        "url": "https://shineandgo.be/lavage-voiture-fleron",
        "telephone": "+32472303701",
        "address": {
            "@type": "PostalAddress",
            "addressLocality": "Fleron",
            "addressRegion": "Liège",
            "addressCountry": "BE"
        },
        "geo": {
