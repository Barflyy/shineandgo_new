...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-clermont',
  },
  openGraph: {
    title: 'Lavage Auto Clermont - Nettoyage à Domicile',
    description: 'Expert lavage auto à Clermont-sur-Berwinne. Nous venons chez vous. Nettoyage voiture complet, intérieur, extérieur. Produits professionnels. Devis immédiat.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Clermont Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Clermont",
                "item": "https://shineandgo.be/nettoyage-voiture-clermont"
            }
        ,
    {
        "@context": "https://schema.org",
