...
export default function HomePage() {
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      {/* Bouton CTA flottant - Visible après scroll */}
      {scrolled && (
        <a
          href="https://wa.me/32472303701?text=Bonjour, je souhaite réserver un nettoyage voiture"
          className="fixed bottom-6 right-6 z-50 px-6 py-4 bg-blue-600 text-white font-medium rounded-full shadow-2xl hover:bg-blue-700 transition-all flex items-center gap-2 touch-manipulation animate-fade-in"
          style={{
