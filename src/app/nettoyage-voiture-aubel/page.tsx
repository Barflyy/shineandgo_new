...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-aubel.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Aubel : intérieur & extérieur | Shine&Go",
      description: "Lavage et nettoyage voiture à domicile à Aubel. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-aubel.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function AubelPage() {
  ...
  const structuredData = generateCityStructuredData('aubel', 'Aubel', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Aubel", url: "https://www.shineandgo.be/nettoyage-voiture-aubel" },
    },
    faqs: [
      {
