...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-mouland",
    },
    openGraph: {
      title: "Nettoyage voiture Mouland à domicile | Résultat showroom garanti",
      description: "Nettoyage auto mobile à Mouland : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-mouland.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Mouland à domicile | Résultat showroom garanti",
      description: "Nettoyage auto mobile à Mouland : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-mouland.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function MoulandPage() {
  ...
  const structuredData = generateCityStructuredData('mouland', 'Mouland', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Mouland", url: "https://shineandgo.be/nettoyage-voiture-mouland" },
    },
    faqs: [
      {
