...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Nettoyage auto mobile à Mouland : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-mouland.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Mouland",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Mouland à domicile | Résultat showroom garanti",
      description: "Nettoyage auto mobile à Mouland : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-mouland.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function MoulandPage() {
  ...
  const structuredData = generateCityStructuredData('mouland', 'Mouland', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Mouland",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Mouland", url: "https://www.shineandgo.be/nettoyage-voiture-mouland" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Mouland ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="mouland" 
        cityName="Mouland"
        csvData={getCSVCityData('nettoyage-voiture-mouland')}
      />
    </>
  );
}
