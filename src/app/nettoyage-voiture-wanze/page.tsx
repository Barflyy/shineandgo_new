...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-wanze.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Wanze : intérieur & extérieur | Shine&Go",
      description: "Nettoyage auto mobile à Wanze : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-wanze.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function WanzePage() {
  ...
  const structuredData = generateCityStructuredData('wanze', 'Wanze', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Wanze", url: "https://www.shineandgo.be/nettoyage-voiture-wanze" },
    },
    faqs: [
      {
