...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-warsage',
  },
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Warsage - Intérieur & Extérieur',
    description: 'Service de nettoyage auto à Warsage. Lavage main professionnel à votre domicile. Déplacement gratuit. Dès 65€. Réservation rapide. ☎ 0472 30 37 01',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Warsage Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Warsage",
                "item": "https://shineandgo.be/nettoyage-voiture-warsage"
            }
        ]
    },
    {
