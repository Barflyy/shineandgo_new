...
export const metadata: Metadata = {
  title: 'Lavage Voiture Extérieur à Domicile | Lavage Main & Cire - Shine&Go',
  description: 'Lavage voiture extérieur à la main à domicile. Technique 2 seaux anti-rayures, nettoyage jantes, dégoudronnage, cire de protection. Dès 85€.',
  alternates: {
    canonical: 'https://shineandgo.be/lavage-exterieur-voiture',
  },
  openGraph: {
    title: 'Lavage Voiture Extérieur à Domicile | Shine&Go',
    description: 'Lavage voiture extérieur professionnel à domicile. Technique 2 seaux, jantes, cire. Dès 85€.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lavage voiture extérieur domicile - Shine&Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...
            },
            {
              ...
              "item": "https://shineandgo.be/lavage-exterieur-voiture"
            }
          ])
        }}
      />
