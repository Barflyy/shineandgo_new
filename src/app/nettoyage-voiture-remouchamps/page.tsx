...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage et nettoyage voiture à domicile à Remouchamps. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-remouchamps.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Remouchamps",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Remouchamps : intérieur & extérieur | Shine&Go",
      description: "Lavage et nettoyage voiture à domicile à Remouchamps. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-remouchamps.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function RemouchampsPage() {
  ...
  const structuredData = generateCityStructuredData('remouchamps', 'Remouchamps', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Remouchamps",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Remouchamps", url: "https://www.shineandgo.be/nettoyage-voiture-remouchamps" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Remouchamps ?",
  ...
  return (
    <>
      ...
      />
      <CityPageTemplateNew 
        citySlug="remouchamps" 
        cityName="Remouchamps"
        csvData={getCSVCityData('nettoyage-voiture-remouchamps')}
      />
    </>
  );
}
