...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-remouchamps",
    },
    openGraph: {
      title: "Lavage auto mobile à Remouchamps : intérieur & extérieur | Shine&Go",
      description: "Lavage et nettoyage voiture à domicile à Remouchamps. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-remouchamps.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Remouchamps : intérieur & extérieur | Shine&Go",
      description: "Lavage et nettoyage voiture à domicile à Remouchamps. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-remouchamps.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function RemouchampsPage() {
  ...
  const structuredData = generateCityStructuredData('remouchamps', 'Remouchamps', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Remouchamps", url: "https://shineandgo.be/nettoyage-voiture-remouchamps" },
    },
    faqs: [
      {
