...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-francorchamps',
  },
  openGraph: {
    title: 'Nettoyage Voiture Francorchamps - Lavage Pro',
    description: 'Lavage auto à Francorchamps. Nous venons chez vous ou sur circuit. Nettoyage complet de votre véhicule. Expertise detailing. Réservation facile.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Francorchamps Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Francorchamps",
                "item": "https://shineandgo.be/nettoyage-voiture-francorchamps"
            }
        ]
    },
    {
