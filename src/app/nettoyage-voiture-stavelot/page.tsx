...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-stavelot',
  },
  openGraph: {
    title: 'Lavage Auto Stavelot - Nettoyage Mobile',
    description: 'Nettoyage auto à Stavelot. Shine&Go se déplace chez vous pour un lavage complet. Intérieur, extérieur, polish. Devis gratuit et immédiat.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Stavelot Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Stavelot",
                "item": "https://shineandgo.be/nettoyage-voiture-stavelot"
            }
        ,
    {
        "@context": "https://schema.org",
