...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Besoin d’un car wash à domicile à Stavelot ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-stavelot.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Stavelot",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Lavage auto mobile à Stavelot : intérieur & extérieur | Shine&Go",
      description: "Besoin d’un car wash à domicile à Stavelot ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-stavelot.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function StavelotPage() {
  ...
  const structuredData = generateCityStructuredData('stavelot', 'Stavelot', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Stavelot",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Stavelot", url: "https://www.shineandgo.be/nettoyage-voiture-stavelot" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Stavelot ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="stavelot" 
        cityName="Stavelot"
        csvData={getCSVCityData('nettoyage-voiture-stavelot')}
      />
    </>
  );
}
