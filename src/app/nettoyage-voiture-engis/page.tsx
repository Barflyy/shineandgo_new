...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Besoin d’un car wash à domicile à Engis ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-engis.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Engis",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Engis à domicile | Résultat showroom garanti",
      description: "Besoin d’un car wash à domicile à Engis ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-engis.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function EngisPage() {
  ...
  const structuredData = generateCityStructuredData('engis', 'Engis', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Engis",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Engis", url: "https://www.shineandgo.be/nettoyage-voiture-engis" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Engis ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="engis" 
        cityName="Engis"
        csvData={getCSVCityData('nettoyage-voiture-engis')}
      />
    </>
  );
}
