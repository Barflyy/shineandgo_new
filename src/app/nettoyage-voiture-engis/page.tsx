...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-engis",
    },
    openGraph: {
      title: "Nettoyage voiture Engis à domicile | Résultat showroom garanti",
      description: "Besoin d’un car wash à domicile à Engis ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-engis.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Engis à domicile | Résultat showroom garanti",
      description: "Besoin d’un car wash à domicile à Engis ? Shine&Go vient chez vous : nettoyage intérieur & extérieur, finition pro, sans file d’attente.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-engis.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function EngisPage() {
  ...
  const structuredData = generateCityStructuredData('engis', 'Engis', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Engis", url: "https://shineandgo.be/nettoyage-voiture-engis" },
    },
    faqs: [
      {
