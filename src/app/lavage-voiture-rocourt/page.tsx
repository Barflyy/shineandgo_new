        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage voiture à <span className="font-semibold">Rocourt</span>
            </h2>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-8 text-center">
              Lavage auto près du Cora et du Kinepolis
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  Rocourt est une zone dynamique. Que vous soyez résident près du stade ou commerçant, nous vous apportons un service de detailing haut de gamme sans que vous ayez à bouger.
                </p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                  Nous sommes habitués aux grands espaces résidentiels de la région et assurons un service discret et efficace.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white">Zone Rocourt</h3>
