...
export const metadata: Metadata = {
  ...
  description: 'Lavage voiture à Stavelot. Shine&Go se déplace chez vous pour un lavage complet. Intérieur, extérieur, polish. Devis gratuit et immédiat.',
  alternates: {
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage voiture à <span className="font-semibold">Stavelot</span>
            </h2>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-8 text-center">
              Lavage auto dans la cité de l'Abbaye
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  Stavelot et ses routes sinueuses. Le plaisir de conduire est meilleur dans une voiture propre. Nous nous occupons de tout, de l'intérieur à l'extérieur.
                </p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                  Redécouvrez le plaisir de monter dans une voiture fraîche et parfaitement nettoyée.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white">Zone Stavelot</h3>
