...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-herstal',
  },
  openGraph: {
    title: 'Nettoyage Auto Herstal - Lavage à Domicile',
    description: 'Expert nettoyage voiture à Herstal. Service de lavage auto mobile directement chez vous ou au travail. Detailing, shampoing sièges, polissage. Devis rapide.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Herstal Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Herstal",
                "item": "https://shineandgo.be/nettoyage-voiture-herstal"
            }
        ,
    {
        "@context": "https://schema.org",
