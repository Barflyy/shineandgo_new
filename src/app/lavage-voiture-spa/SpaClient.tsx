...
function HeroSection() {
    const handleBooking = () => { window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage voiture à Spa. 🚗', '_blank'); };
                ...
                <div className="max-w-3xl mx-auto">
                    <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} className="flex justify-center mb-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200/80 shadow-sm">
                            ...
                            <span className="text-xs font-semibold text-slate-700">Déplacement gratuit à Spa</span>
                        </div>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }} className="text-center mb-6">
                        <h1 className="font-display text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-4">
                            ...
                            <span className="relative inline-block">
                                <span className="relative z-10 bg-gradient-to-r from-sky-500 to-emerald-500 bg-clip-text text-transparent">à Spa</span>
                        ...
                        <p className="text-lg sm:text-xl text-slate-600 max-w-xl mx-auto leading-relaxed">
                            Valeting spécialiste <strong className="text-slate-900">post-circuit et post-Fagnes</strong>. Boue, gomme, insectes écrasés ? On remet votre bolide à neuf.
                        </p>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="flex flex-col gap-3 mb-8">
                        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handleBooking} className="w-full sm:w-auto sm:mx-auto group relative overflow-hidden px-8 py-5 bg-slate-900 text-white font-bold text-lg rounded-2xl shadow-2xl shadow-slate-900/25 transition-all duration-300">
                            <span className="relative z-10 flex items-center justify-center gap-3"><CalendarCheck className="w-5 h-5" /> Réserver à Spa <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" /></span>
...
function BenefitsSection() {
    const benefits = [
        { icon: Car, title: "Spécialiste post-circuit", description: "Track day à Spa-Francorchamps ? Gomme fondue, insectes, poussière de frein... On nettoie tout.", color: "sky" },
        { icon: Droplets, title: "Traitement Fagnes", description: "Boue des sentiers, humidité ardennaise, résine de sapin. On redonne l'éclat après vos escapades.", color: "emerald" },
        { icon: Shield, title: "Service hôtelier", description: "En cure thermale ? On vient à votre hôtel. Votre voiture brille pendant que vous vous relaxez.", color: "violet" },
    ];
        ...
        <section className="py-16 sm:py-20 bg-white">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Pourquoi choisir Shine&Go à Spa ?</h2>
                </motion.div>
        ...
        <section id="services" className="py-16 sm:py-24 bg-gradient-to-b from-slate-50 to-white">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    ...
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-3">Tarifs lavage voiture à Spa</h2>
                    <p className="text-slate-600 max-w-md mx-auto">Tarifs transparents, déplacement gratuit à Spa et environs.</p>
                </motion.div>
...
function TestimonialsSection() {
    const testimonials = [
        { name: 'Philippe R.', location: 'Spa Centre', text: 'Après un track day à Francorchamps, ma 911 était couverte d\'insectes et de gomme. Résultat showroom !', avatar: '👨' },
        { name: 'Céline D.', location: 'Spa', text: 'En cure thermale, ils sont venus à mon hôtel. Voiture nickel sans bouger. Service 5 étoiles.', avatar: '👩' },
        { name: 'Eric M.', location: 'Hautes Fagnes', text: 'Retour de randonnée, voiture pleine de boue des Fagnes. Transformation spectaculaire !', avatar: '👨' },
    ];
        ...
        <section className="py-16 sm:py-24 bg-white overflow-hidden">
            <div className="max-w-6xl mx-auto px-5">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
                    ...
                    <p className="text-slate-600">Ce que nos clients disent de nous à Spa</p>
                </motion.div>
...
function FAQSection() {
    const faqs = [
        { question: "Nettoyez-vous les voitures après un track day à Francorchamps ?", answer: "Notre spécialité ! Gomme fondue sur les ailes, insectes écrasés, poussière de frein... On élimine tout avec des produits adaptés." },
        { question: "Intervenez-vous dans les hôtels de Spa ?", answer: "Oui ! Parking du Radisson, des Thermes, ou autres. Profitez de votre cure, on s'occupe de votre voiture." },
        { question: "Ma voiture est pleine de boue des Fagnes, c'est un problème ?", answer: "Au contraire ! On traite régulièrement les retours de randonnée. Boue séchée, feuilles, résine... tout disparaît." },
        { question: "Traitez-vous les véhicules de collection (circuit) ?", answer: "Avec le plus grand soin. Produits doux, techniques manuelles, respect des peintures anciennes et sensibles." }
    ];
...
function CTASection() {
    const handleBooking = () => { window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage voiture à Spa. 🚗', '_blank'); };
    const zones = ['Herve', 'Verviers', 'Theux', 'Malmedy', 'Liège'];
        ...
        <section className="relative py-16 sm:py-24 overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto px-5 text-center">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                    ...
                    <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">Prêt pour une voiture<br className="sm:hidden" /> comme neuve à Spa ?</h2>
                    ...
                    <div className="pt-8 border-t border-white/10">
                        <p className="text-sm text-white/50 mb-4 flex items-center justify-center gap-2"><MapPin className="w-4 h-4" /> Zones proches de Spa</p>
