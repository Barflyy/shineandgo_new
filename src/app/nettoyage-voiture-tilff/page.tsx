...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-tilff",
    },
    openGraph: {
      title: "Lavage voiture à Tilff (Wallonie) | Shine&Go se déplace chez vous",
      description: "Nettoyage auto mobile à Tilff : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-tilff.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Lavage voiture à Tilff (Wallonie) | Shine&Go se déplace chez vous",
      description: "Nettoyage auto mobile à Tilff : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-tilff.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function TilffPage() {
  ...
  const structuredData = generateCityStructuredData('tilff', 'Tilff', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Tilff", url: "https://shineandgo.be/nettoyage-voiture-tilff" },
    },
    faqs: [
      {
