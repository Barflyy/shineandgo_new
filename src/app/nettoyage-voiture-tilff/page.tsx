...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Nettoyage auto mobile à Tilff : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-tilff.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Tilff",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Lavage voiture à Tilff (Wallonie) | Shine&Go se déplace chez vous",
      description: "Nettoyage auto mobile à Tilff : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-tilff.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function TilffPage() {
  // Générer les données structurées avec toutes les informations du CSV
  const structuredData = generateCityStructuredData('tilff', 'Tilff', {
    title: "Lavage voiture à Tilff (Wallonie) – Shine&Go se déplace chez vous",
    description: "Nettoyage auto mobile à Tilff : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
    price: "79",
    currency: "EUR",
    ...
    imageDescription: "Nettoyage voiture à domicile à Tilff",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Tilff", url: "https://www.shineandgo.be/nettoyage-voiture-tilff" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Tilff ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="tilff" 
        cityName="Tilff"
        csvData={getCSVCityData('nettoyage-voiture-tilff')}
      />
    </>
  );
}
