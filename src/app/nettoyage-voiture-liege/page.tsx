        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Esthétique automobile et lavage à domicile à Liège</h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Shine&Go s'occupe de votre voiture à Liège. Profitez d'un service professionnel méticuleux avec les produits Koch-Chemie. Nous couvrons l'ensemble des codes postaux de Liège, apportant notre savoir-faire de detailer professionnel directement dans votre garage ou sur votre allée.
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Liège",
                "item": "https://shineandgo.be/nettoyage-voiture-liege"
            }
        ,
    {
        "@context": "https://schema.org",
