...
export const metadata: Metadata = {
  title: 'Nettoyage Voiture à Domicile Liège - Intérieur & Extérieur',
  description: 'Expert du nettoyage véhicule à Liège. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
  alternates: {
  ...
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Liège - Intérieur & Extérieur',
    description: 'Expert du nettoyage véhicule à Liège. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
    url: 'https://shineandgo.be/nettoyage-voiture-liege',
    siteName: 'Shine&Go',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Liège Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Nettoyage & Lavage voiture <span className="block font-semibold mt-2 text-gray-900">à Domicile sur Liège</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Mieux qu'un car wash : votre expert detailing mobile
              <span className="block mt-2 text-base text-gray-400 font-normal">Nettoyage véhicule complet • Dès 65€ • Déplacement gratuit</span>
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-gray-900 mb-4 sm:mb-6 leading-tight">
              Réservez votre nettoyage à Liège
            </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Nettoyage Voiture à Domicile Liège",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Shine&Go",
            ...
            "description": "Service de nettoyage automobile à domicile à Liège. Lavage intérieur et extérieur, detailing, protection céramique.",
            "offers": {
              "@type": "Offer",
              "price": "65",
              "priceCurrency": "EUR"
