...
export const generateMetadata = (): Metadata => {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-liege.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture Liège à domicile | Résultat showroom garanti",
      description: "Lavage voiture Liège à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-liege.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function LigePage() {
  ...
  const structuredData = generateCityStructuredData('liege', 'Liège', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Liège", url: "https://www.shineandgo.be/nettoyage-voiture-liege" },
    },
    faqs: [
      {
