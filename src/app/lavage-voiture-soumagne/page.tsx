...
export default function SoumagnePage() {
  ...
  return (
    <>
      <Head>
        <title>Nettoyage Voiture à Domicile Soumagne | En 90min dès 65€ - Shine&Go</title>
        <meta name="description" content="Nettoyage voiture premium à Soumagne et environs. Service mobile professionnel en 90 min. Produits Koch-Chemie. Résultat showroom. À partir de 65€. ☎ 0472 30 37 01" />
      </Head>
        ...
        <div className="container mx-auto px-6 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-8 sm:mb-12 font-light leading-relaxed px-4 sm:px-0">
              Lavage mobile professionnel à Soumagne
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-light text-gray-900 mb-4">
                Nous intervenons aussi près de Soumagne
              </h2>
