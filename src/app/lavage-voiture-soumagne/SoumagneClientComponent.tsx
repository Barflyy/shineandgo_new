...
export default function SoumagneClientComponent() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Oui, nous intervenons dans toute la région de Soumagne et environs (Herve, Fléron, Olne) avec un déplacement gratuit jusqu'à 25 km. Au-delà, un supplément peut s'appliquer selon la distance. Contactez-nous pour vérifier la disponibilité dans votre zone."
    },
    {
