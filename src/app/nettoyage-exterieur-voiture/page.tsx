        ...
        <div className="container mx-auto px-6 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-slate-600 mb-8 sm:mb-12 font-light leading-relaxed px-4 sm:px-0">
              ...
              <span className="block mt-2 text-sm sm:text-base text-slate-400">Lavage • Polish • Cire protection • Dès 85€</span>
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs sm:text-sm">
                <li><Link href="/nettoyage-interieur-voiture" className="text-slate-600 hover:text-slate-900 transition-colors">Extérieur</Link></li>
