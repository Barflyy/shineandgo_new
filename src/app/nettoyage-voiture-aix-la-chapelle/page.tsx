...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-aix-la-chapelle",
    },
    openGraph: {
      title: "Nettoyage voiture à domicile à Aix-la-chapelle | Shine&Go (service premium)",
      description: "Lavage voiture Aix-la-chapelle à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-aix-la-chapelle.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Aix-la-chapelle | Shine&Go (service premium)",
      description: "Lavage voiture Aix-la-chapelle à domicile : aspirateur, mousse active, protection cire. Formules dès 39€. Satisfaction garantie !",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-aix-la-chapelle.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function AixlachapellePage() {
  ...
  const structuredData = generateCityStructuredData('aix-la-chapelle', 'Aix-la-chapelle', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Aix-la-chapelle", url: "https://shineandgo.be/nettoyage-voiture-aix-la-chapelle" },
    },
    faqs: [
      {
