...
export const metadata: Metadata = {
  title: 'Nettoyage Voiture à Domicile Boncelles - Intérieur & Extérieur',
  description: 'Expert du nettoyage véhicule à Boncelles. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
  alternates: {
    canonical: 'https://shineandgo.be/nettoyage-voiture-boncelles',
  },
  openGraph: {
    title: 'Nettoyage Voiture à Domicile Boncelles - Intérieur & Extérieur',
    description: 'Expert du nettoyage véhicule à Boncelles. Lavage main anti-rayures à domicile. Prix et Tarifs clairs. Déplacement gratuit. Dès 65€. ☎ 0472 30 37 01',
    url: 'https://shineandgo.be/nettoyage-voiture-boncelles',
    siteName: 'Shine&Go',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Nettoyage voiture domicile Boncelles Shine and Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Boncelles",
                "item": "https://shineandgo.be/nettoyage-voiture-boncelles"
            }
        ]
    },
    {
