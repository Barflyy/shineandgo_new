...
export const metadata: Metadata = {
  title: 'Lavage Voiture à Domicile Oupeye - Lavage Auto Pro',
  ...
  alternates: {
    canonical: 'https://shineandgo.be/lavage-voiture-oupeye',
  },
  openGraph: {
    title: 'Lavage Voiture à Domicile Oupeye - Lavage Auto Pro',
    description: 'Expert du nettoyage auto à Oupeye. Nous venons chez vous pour un lavage complet intérieur et extérieur. Déplacement gratuit. Résultat garanti.',
    url: 'https://shineandgo.be/lavage-voiture-oupeye',
    siteName: 'Shine&Go',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lavage voiture domicile Oupeye - Shine&Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
...
export default function OupeyePage() {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Combien coûte un lavage voiture à domicile à Oupeye ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nos tarifs à Oupeye démarrent à 65€ pour un lavage intérieur, 50€ pour l'extérieur, et 100€ pour la formule complète. Le déplacement est inclus."
        }
      },
      {
        "@type": "Question",
        "name": "Intervenez-vous à Oupeye pour le lavage voiture ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Oui, nous intervenons à Oupeye et dans toutes les communes environnantes. Réservez en ligne ou par téléphone."
        }
      },
      {
        "@type": "Question",
        "name": "Quels services de lavage proposez-vous à Oupeye ?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Nous proposons le lavage intérieur, extérieur et complet à Oupeye. Nous utilisons des produits professionnels Koch-Chemie."
        }
      }
    ]
  }
        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 dark:text-white mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Expert en Detailing et Nettoyage Auto à Domicile : Oupeye</h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Lavage voiture professionnel directement chez vous à Oupeye. Profitez d'un service premium avec les meilleurs produits du marché.
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <a
                href="https://wa.me/32472303701?text=Bonjour, je souhaite réserver un nettoyage voiture à Oupeye"
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-gray-500 dark:text-gray-400 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              <span className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Intervention rapide</span>
              <span className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Sans frais de déplacement</span>
              <span className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-600 dark:text-blue-400" /> Paiement fin de prestation</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage auto à <span className="font-semibold">Oupeye</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed text-pretty">
              Votre voiture mérite le meilleur traitement. Shine&Go se déplace partout à Oupeye pour un nettoyage intérieur et extérieur de qualité. Nous couvrons l'ensemble des codes postaux de Oupeye, apportant notre savoir-faire de detailer professionnel directement dans votre garage ou sur votre allée.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-4 text-balance">
                Notre zone d'action près d'Oupeye
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 text-pretty">
                Nous couvrons toute la Basse-Meuse
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group p-8 bg-gradient-to-br from-orange-50 to-white rounded-2xl border border-orange-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center">
                ...
                <p className="text-sm text-gray-600 text-pretty">Nous venons à Oupeye quand cela vous arrange, à domicile ou au bureau</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto items-start">
            ...
            <article className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 h-full">
              <div className="mb-8">
                ...
                <p className="text-gray-500 text-sm">Rénovation de l'habitacle</p>
              </div>
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un nettoyage intérieur à Oupeye - 65€"
            ...
            <article className="relative group bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-2xl hover:shadow-blue-900/20 hover:-translate-y-1 transition-all duration-300 md:-mt-4 md:mb-4 z-10">
              ...
              <div className="mb-8">
                ...
                <p className="text-slate-400 text-sm">La totale pour votre voiture</p>
              </div>
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite le nettoyage complet à Oupeye - 120€"
            ...
            <article className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-blue-100 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 transition-all duration-300 h-full">
              <div className="mb-8">
                ...
                <p className="text-gray-500 text-sm">Lavage main & Cire</p>
              </div>
              ...
              <a
                href="https://wa.me/32472303701?text=Je souhaite un lavage extérieur à Oupeye - 85€"
                className="block w-full py-4 border border-gray-200 text-gray-900 font-medium rounded-xl text-center hover:bg-gray-50 hover:border-gray-300 transition-all"
              >
                Réserver
              </a>
              ...
              {[
                ...
                <div key={i} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  <div className="relative aspect-[3/4] w-full overflow-hidden">
                    <Image
                      src={item.image}
                      alt={`${item.title} - Lavage voiture Oupeye`}
                      fill
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
              <a
                href="https://www.google.com/search?q=shine+and+go+oupeye"
                target="_blank"
                rel="noopener noreferrer"
...
<section className="py-16 sm:py-20 md:py-32 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-12">
              Réservez votre créneau en quelques secondes via WhatsApp.
            </p>
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([
    {
        "@context": "https://schema.org",
        "@type": "AutoWash",
        "name": "Shine&Go - Lavage voiture Oupeye",
        "description": "Service de nettoyage et detailing automobile à domicile à Oupeye.",
        "url": "https://shineandgo.be/lavage-voiture-oupeye",
        ...
        "aggregateRating": {
    ...
    },
            {
                ...
                "position": 2,
                "name": "Oupeye",
                "item": "https://shineandgo.be/lavage-voiture-oupeye"
            }
        ,
    {
        "@context": "https://schema.org",
