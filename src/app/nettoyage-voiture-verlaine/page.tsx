...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-verlaine",
    },
    openGraph: {
      title: "Nettoyage voiture à domicile à Verlaine | Shine&Go (service premium)",
      description: "Nettoyage auto mobile à Verlaine : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-verlaine.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Verlaine | Shine&Go (service premium)",
      description: "Nettoyage auto mobile à Verlaine : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-verlaine.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function VerlainePage() {
  ...
  const structuredData = generateCityStructuredData('verlaine', 'Verlaine', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Verlaine", url: "https://shineandgo.be/nettoyage-voiture-verlaine" },
    },
    faqs: [
      {
