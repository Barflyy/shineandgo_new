...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Nettoyage auto mobile à Verlaine : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-verlaine.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Verlaine",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Verlaine | Shine&Go (service premium)",
      description: "Nettoyage auto mobile à Verlaine : intérieur, extérieur, pack complet. Déplacement gratuit ≤25 km. Réservez votre créneau en ligne.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-verlaine.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function VerlainePage() {
  ...
  const structuredData = generateCityStructuredData('verlaine', 'Verlaine', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Verlaine",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Verlaine", url: "https://www.shineandgo.be/nettoyage-voiture-verlaine" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Verlaine ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="verlaine" 
        cityName="Verlaine"
        csvData={getCSVCityData('nettoyage-voiture-verlaine')}
      />
    </>
  );
}
