...
export const metadata: Metadata = {
  ...
  description: "Service de nettoyage automobile à Chaudfontaine : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Chaudfontaine | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Chaudfontaine : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
...
export default function CityPage() {
  const nearbyCities = [
    { name: "Liège", slug: "liege", distance: "15 km" },
    { name: "Seraing", slug: "seraing", distance: "12 km" },
    { name: "Fléron", slug: "fleron", distance: "8 km" },
    { name: "Soumagne", slug: "soumagne", distance: "5 km" },
    { name: "Esneux", slug: "esneux", distance: "18 km" },
    { name: "Ans", slug: "ans", distance: "11 km" }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <CityServiceContent
          city="Chaudfontaine"
          region="commune de l'agglomération liégeoise"
          villages={["Liège","Seraing","Fléron","Soumagne","Esneux"]}
          nearbyCities={["Liège","Seraing","Fléron","Soumagne","Esneux","Ans"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Chaudfontaine</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Chaudfontaine" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Chaudfontaine" nearbyCities={nearbyCities} />
