...
export const metadata: Metadata = {
  title: "Lavage voiture Chaudfontaine | Shine&Go à domicile",
  description: "Service de nettoyage automobile à Chaudfontaine : lavage intérieur/extérieur à domicile avec produits haut de gamme. Station thermale, intervention rapide.",
  openGraph: {
    title: "Lavage voiture Chaudfontaine | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Chaudfontaine : lavage intérieur/extérieur à domicile avec produits haut de gamme. Station thermale, intervention rapide.",
    type: "website",
    locale: "fr_BE",
    url: "https://www.shineandgo.be/zone-intervention/chaudfontaine",
  ...
  alternates: {
    canonical: `/zone-intervention/chaudfontaine`,
  },
};
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Nettoyage voiture à Chaudfontaine - Service à domicile premium
          </h1>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 mb-12">
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-white/90 leading-relaxed text-lg">
              Vous habitez à Chaudfontaine, station thermale réputée, ou dans les villages environnants comme Vaux-sous-Chèvremont, Beaufays ou Embourg ? Profitez du service de nettoyage automobile à domicile de Shine&Go. Notre équipe intervient sur place, sans branchement nécessaire, avec des produits Koch Chemie haut de gamme. Que vous ayez besoin d&apos;un nettoyage intérieur minutieux pour éliminer les traces de vos déplacements quotidiens, d&apos;un lavage extérieur sans trace ou d&apos;une prestation complète, nous adaptons notre méthode à chaque véhicule. Idéal pour les clients exigeants de la région chaudfontainoise souhaitant gagner du temps sans faire de compromis sur la qualité. Réservez votre créneau directement en ligne en quelques clics.
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 mb-8">
            <h2 className="text-3xl font-bold text-white mb-4">
              Prêt pour un nettoyage professionnel à Chaudfontaine ?
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-white/70 text-sm">Sous 2h dans Chaudfontaine et environs</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-white/60">
              © 2025 Shine&Go Premium - Service de nettoyage automobile à Chaudfontaine et environs
            </p>
