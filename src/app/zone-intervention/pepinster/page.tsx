...
export const metadata: Metadata = {
  ...
  description: "Service de nettoyage automobile à Pepinster : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Pepinster | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Pepinster : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
...
export default function CityPage() {
  const nearbyCities = [
    { name: "Verviers", slug: "verviers", distance: "7 km" },
    { name: "Theux", slug: "theux", distance: "16 km" },
    { name: "Spa", slug: "spa", distance: "7 km" },
    { name: "Esneux", slug: "esneux", distance: "10 km" },
    { name: "Sprimont", slug: "sprimont", distance: "6 km" },
    { name: "Liège", slug: "liege", distance: "9 km" }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <CityServiceContent
          ...
          villages={["Verviers","Theux","Spa","Esneux","Sprimont"]}
          nearbyCities={["Verviers","Theux","Spa","Esneux","Sprimont","Liège"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Pepinster</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Pepinster" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Pepinster" nearbyCities={nearbyCities} />
