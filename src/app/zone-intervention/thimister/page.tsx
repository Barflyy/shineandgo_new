...
export const metadata: Metadata = {
  ...
  description: "Service de nettoyage automobile à Thimister : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Thimister | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Thimister : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
...
export default function CityPage() {
  const nearbyCities = [
    { name: "Herve", slug: "herve", distance: "13 km" },
    { name: "Battice", slug: "battice", distance: "5 km" },
    { name: "Olne", slug: "olne", distance: "10 km" },
    { name: "Aubel", slug: "aubel", distance: "14 km" },
    { name: "Welkenraedt", slug: "welkenraedt", distance: "6 km" },
    { name: "Plombières", slug: "plombieres", distance: "16 km" }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <CityServiceContent
          ...
          villages={["Herve","Battice","Charneux","Olne","Welkenraedt"]}
          nearbyCities={["Herve","Battice","Olne","Aubel","Welkenraedt","Plombières"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Thimister</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Thimister" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Thimister" nearbyCities={nearbyCities} />
