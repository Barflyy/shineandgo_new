...
export const metadata: Metadata = {
  title: "Lavage voiture Theux | Shine&Go à domicile",
  description: "Service de nettoyage automobile à Theux : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Theux | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Theux : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
    locale: "fr_BE",
    url: "https://www.shineandgo.be/zone-intervention/theux",
  ...
  alternates: {
    canonical: `/zone-intervention/theux`,
  },
};

export default function CityPage() {
  const nearbyCities = [
    { name: "Verviers", slug: "verviers", distance: "13 km" },
    { name: "Spa", slug: "spa", distance: "6 km" },
    { name: "Pepinster", slug: "pepinster", distance: "9 km" },
    { name: "Esneux", slug: "esneux", distance: "17 km" },
    { name: "Sprimont", slug: "sprimont", distance: "12 km" },
    { name: "Liège", slug: "liege", distance: "10 km" }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      {/* Header */}
      <Header cityName="Theux" />
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Nettoyage voiture à Theux - Service à domicile premium
          </h1>
        ...
        <CityServiceContent
          ...
          villages={["Verviers","Spa","Pepinster","Esneux","Sprimont"]}
          nearbyCities={["Verviers","Spa","Pepinster","Esneux","Sprimont","Liège"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Theux</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Theux" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Theux" nearbyCities={nearbyCities} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-white/60">
              © 2025 Shine&Go Premium - Service de nettoyage automobile à Theux et environs
            </p>
