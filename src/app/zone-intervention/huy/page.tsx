...
export const metadata: Metadata = {
  title: "Lavage voiture Huy | Shine&Go à domicile",
  description: "Service de nettoyage automobile à Huy : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Huy | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Huy : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
    locale: "fr_BE",
    url: "https://www.shineandgo.be/zone-intervention/huy",
  ...
  alternates: {
    canonical: `/zone-intervention/huy`,
  },
};

export default function CityPage() {
  const nearbyCities = [
    { name: "Waremme", slug: "waremme", distance: "6 km" },
    { name: "Vise", slug: "vise", distance: "16 km" },
    { name: "Amay", slug: "amay", distance: "17 km" },
    { name: "Engis", slug: "engis", distance: "13 km" },
    { name: "Saint-Georges", slug: "saint-georges", distance: "10 km" },
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Nettoyage voiture à Huy - Service à domicile premium
          </h1>
        ...
        <CityServiceContent
          ...
          villages={["Waremme","Vise","Amay","Engis","Saint-Georges"]}
          nearbyCities={["Waremme","Vise","Amay","Engis","Saint-Georges","Liège"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Huy</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Huy" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Huy" nearbyCities={nearbyCities} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-white/60">
              © 2025 Shine&Go Premium - Service de nettoyage automobile à Huy et environs
            </p>
