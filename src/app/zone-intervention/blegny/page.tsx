...
export const metadata: Metadata = {
  title: "Lavage voiture Blegny | Shine&Go à domicile",
  description: "Service de nettoyage automobile à Blegny : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Blegny | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Blegny : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
    locale: "fr_BE",
    url: "https://www.shineandgo.be/zone-intervention/blegny",
  ...
  alternates: {
    canonical: `/zone-intervention/blegny`,
  },
};

export default function CityPage() {
  const nearbyCities = [
    { name: "Vise", slug: "vise", distance: "19 km" },
    { name: "Huy", slug: "huy", distance: "11 km" },
    { name: "Waremme", slug: "waremme", distance: "14 km" },
    { name: "Amay", slug: "amay", distance: "9 km" },
    { name: "Saint-Georges", slug: "saint-georges", distance: "5 km" },
    { name: "Liège", slug: "liege", distance: "15 km" }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      {/* Header */}
      <Header cityName="Blegny" />
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Nettoyage voiture à Blegny - Service à domicile premium
          </h1>
        ...
        <CityServiceContent
          ...
          villages={["Vise","Huy","Waremme","Amay","Saint-Georges"]}
          nearbyCities={["Vise","Huy","Waremme","Amay","Saint-Georges","Liège"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Blegny</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Blegny" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Blegny" nearbyCities={nearbyCities} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-white/60">
              © 2025 Shine&Go Premium - Service de nettoyage automobile à Blegny et environs
            </p>
