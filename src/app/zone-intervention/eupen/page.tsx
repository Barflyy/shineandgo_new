...
export const metadata: Metadata = {
  ...
  description: "Nettoyage automobile à Eupen : service intérieur/extérieur à domicile avec produits professionnels. Capitale germanophone, intervention rapide.",
  openGraph: {
    title: "Lavage voiture Eupen | Shine&Go à domicile",
    description: "Nettoyage automobile à Eupen : service intérieur/extérieur à domicile avec produits professionnels. Capitale germanophone, intervention rapide.",
    type: "website",
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 mb-8">
            <h2 className="text-3xl font-bold text-white mb-4">
              Prêt pour un nettoyage professionnel à Eupen ?
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-white/70 text-sm">Sous 2h dans Eupen et environs</p>
            </div>
