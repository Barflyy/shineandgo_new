...
export const metadata: Metadata = {
  ...
  description: "Service de nettoyage automobile à Herve : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit. Réservez en ligne !",
  openGraph: {
    title: "Lavage voiture Herve | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Herve : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit. Réservez en ligne !",
    type: "website",
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 mb-12">
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-white/90 leading-relaxed text-lg">
              Vous habitez à Herve, capitale du fromage, ou dans les villages environnants comme Battice, Thimister ou Charneux ? Profitez du service de nettoyage automobile à domicile de Shine&Go. Notre équipe intervient sur place, sans branchement nécessaire, avec des produits Koch Chemie haut de gamme. Que vous ayez besoin d&apos;un nettoyage intérieur minutieux pour éliminer les traces de vos déplacements quotidiens, d&apos;un lavage extérieur sans trace ou d&apos;une prestation complète, nous adaptons notre méthode à chaque véhicule. Idéal pour les clients exigeants du Pays de Herve souhaitant gagner du temps sans faire de compromis sur la qualité. Réservez votre créneau directement en ligne en quelques clics.
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 mb-8">
            <h2 className="text-3xl font-bold text-white mb-4">
              Prêt pour un nettoyage professionnel à Herve ?
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-white/70 text-sm">Sous 2h dans Herve et environs</p>
            </div>
