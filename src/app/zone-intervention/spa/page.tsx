...
export const metadata: Metadata = {
  ...
  description: "Nettoyage automobile à Spa : service intérieur/extérieur à domicile avec produits professionnels. Ville thermale, intervention rapide. Devis gratuit !",
  openGraph: {
    title: "Lavage voiture Spa | Shine&Go à domicile",
    description: "Nettoyage automobile à Spa : service intérieur/extérieur à domicile avec produits professionnels. Ville thermale, intervention rapide. Devis gratuit !",
    type: "website",
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 mb-12">
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-white/90 leading-relaxed text-lg">
              Vous habitez à Spa, ville thermale réputée, ou dans les villages environnants comme Nivezé, Creppe ou Marteau ? Profitez du service de nettoyage automobile à domicile de Shine&Go. Nous intervenons sur place, sans branchement nécessaire, avec des produits haut de gamme. Que vous ayez besoin d&apos;un nettoyage intérieur minutieux pour éliminer les traces de vos déplacements quotidiens, d&apos;un lavage extérieur sans trace ou d&apos;une prestation complète, nous adaptons notre méthode à chaque véhicule. Idéal pour les clients exigeants de la région spadoise souhaitant gagner du temps sans faire de compromis sur la qualité. Réservez votre créneau directement en ligne en quelques clics.
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 mb-8">
            <h2 className="text-3xl font-bold text-white mb-4">
              Prêt pour un nettoyage professionnel à Spa ?
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-white/70 text-sm">Sous 2h dans Spa et environs</p>
            </div>
