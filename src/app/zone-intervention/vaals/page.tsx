...
export const metadata: Metadata = {
  title: "Lavage voiture Vaals | Shine&Go à domicile",
  description: "Service de nettoyage automobile à Vaals : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Vaals | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Vaals : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
    locale: "fr_BE",
    url: "https://www.shineandgo.be/zone-intervention/vaals",
  ...
  alternates: {
    canonical: `/zone-intervention/vaals`,
  },
};

export default function CityPage() {
  const nearbyCities = [
    { name: "Aix-la-Chapelle", slug: "aix-la-chapelle", distance: "16 km" },
    { name: "Raeren", slug: "raeren", distance: "8 km" },
    { name: "Eupen", slug: "eupen", distance: "16 km" },
    { name: "Kelmis", slug: "kelmis", distance: "14 km" },
    { name: "Plombières", slug: "plombieres", distance: "19 km" },
    { name: "Welkenraedt", slug: "welkenraedt", distance: "13 km" }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      {/* Header */}
      <Header cityName="Vaals" />
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Nettoyage voiture à Vaals - Service à domicile premium
          </h1>
        ...
        <CityServiceContent
          city="Vaals"
          region="ville frontalière des Pays-Bas"
          villages={["Aix-la-Chapelle","Raeren","Eupen","Kelmis","Plombières"]}
          nearbyCities={["Aix-la-Chapelle","Raeren","Eupen","Kelmis","Plombières","Welkenraedt"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Vaals</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Vaals" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Vaals" nearbyCities={nearbyCities} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-white/60">
              © 2025 Shine&Go Premium - Service de nettoyage automobile à Vaals et environs
            </p>
