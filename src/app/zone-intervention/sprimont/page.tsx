...
export const metadata: Metadata = {
  ...
  description: "Service de nettoyage automobile à Sprimont : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Sprimont | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Sprimont : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
...
export default function CityPage() {
  const nearbyCities = [
    ...
    { name: "Esneux", slug: "esneux", distance: "16 km" },
    { name: "Theux", slug: "theux", distance: "7 km" },
    { name: "Pepinster", slug: "pepinster", distance: "7 km" },
    { name: "Chaudfontaine", slug: "chaudfontaine", distance: "8 km" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <CityServiceContent
          ...
          villages={["Liège","Esneux","Theux","Pepinster","Chaudfontaine"]}
          nearbyCities={["Liège","Esneux","Theux","Pepinster","Chaudfontaine","Verviers"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Sprimont</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Sprimont" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Sprimont" nearbyCities={nearbyCities} />
