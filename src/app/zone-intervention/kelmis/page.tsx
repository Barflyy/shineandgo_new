...
export const metadata: Metadata = {
  title: "Lavage voiture Kelmis | Shine&Go à domicile",
  description: "Service de nettoyage automobile à Kelmis : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Kelmis | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Kelmis : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
    locale: "fr_BE",
    url: "https://www.shineandgo.be/zone-intervention/kelmis",
  ...
  alternates: {
    canonical: `/zone-intervention/kelmis`,
  },
};

export default function CityPage() {
  const nearbyCities = [
    { name: "Eupen", slug: "eupen", distance: "18 km" },
    { name: "Raeren", slug: "raeren", distance: "8 km" },
    { name: "Lontzen", slug: "lontzen", distance: "5 km" },
    { name: "Plombières", slug: "plombieres", distance: "12 km" },
    { name: "Welkenraedt", slug: "welkenraedt", distance: "14 km" },
    { name: "Aubel", slug: "aubel", distance: "18 km" }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      {/* Header */}
      <Header cityName="Kelmis" />
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Nettoyage voiture à Kelmis - Service à domicile premium
          </h1>
        ...
        <CityServiceContent
          ...
          villages={["Eupen","Raeren","Lontzen","Plombières","Welkenraedt"]}
          nearbyCities={["Eupen","Raeren","Lontzen","Plombières","Welkenraedt","Aubel"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Kelmis</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Kelmis" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Kelmis" nearbyCities={nearbyCities} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-white/60">
              © 2025 Shine&Go Premium - Service de nettoyage automobile à Kelmis et environs
            </p>
