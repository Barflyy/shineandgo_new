...
export const metadata: Metadata = {
  title: "Lavage voiture Ans | Shine&Go à domicile",
  description: "Service de nettoyage automobile à Ans : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
  openGraph: {
    title: "Lavage voiture Ans | Shine&Go à domicile",
    description: "Service de nettoyage automobile à Ans : lavage intérieur/extérieur à domicile avec produits haut de gamme. Intervention rapide, devis gratuit.",
    type: "website",
    locale: "fr_BE",
    url: "https://www.shineandgo.be/zone-intervention/ans",
  ...
  alternates: {
    canonical: `/zone-intervention/ans`,
  },
};

export default function CityPage() {
  const nearbyCities = [
    { name: "Liège", slug: "liege", distance: "6 km" },
    { name: "Seraing", slug: "seraing", distance: "6 km" },
    { name: "Chaudfontaine", slug: "chaudfontaine", distance: "11 km" },
    { name: "Fléron", slug: "fleron", distance: "12 km" },
    { name: "Soumagne", slug: "soumagne", distance: "8 km" },
    { name: "Esneux", slug: "esneux", distance: "15 km" }
  ];
  return (
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Nettoyage voiture à Ans - Service à domicile premium
          </h1>
        ...
        <CityServiceContent
          ...
          nearbyCities={["Liège","Seraing","Chaudfontaine","Fléron","Soumagne","Esneux"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Ans</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Ans" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Ans" nearbyCities={nearbyCities} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-white/60">
              © 2025 Shine&Go Premium - Service de nettoyage automobile à Ans et environs
            </p>
