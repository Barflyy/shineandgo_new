...
export default function CityPage() {
  const nearbyCities = [
    { name: "Verviers", slug: "verviers", distance: "9 km" },
    { name: "Pepinster", slug: "pepinster", distance: "9 km" },
    { name: "Theux", slug: "theux", distance: "14 km" },
    { name: "Spa", slug: "spa", distance: "9 km" },
    { name: "Malmedy", slug: "malmedy", distance: "19 km" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <CityServiceContent
          ...
          villages={["Verviers","Pepinster","Theux","Spa","Malmedy"]}
          nearbyCities={["Verviers","Pepinster","Theux","Spa","Malmedy","Eupen"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Dison</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Dison" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Dison" nearbyCities={nearbyCities} />
