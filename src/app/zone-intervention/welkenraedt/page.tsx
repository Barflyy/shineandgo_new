...
export default function CityPage() {
  const nearbyCities = [
    { name: "Herve", slug: "herve", distance: "12 km" },
    { name: "Battice", slug: "battice", distance: "5 km" },
    { name: "Thimister", slug: "thimister", distance: "18 km" },
    { name: "Olne", slug: "olne", distance: "15 km" },
    { name: "Aubel", slug: "aubel", distance: "16 km" },
    { name: "Plombières", slug: "plombieres", distance: "5 km" }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <CityServiceContent
          city="Welkenraedt"
          region="ville du Pays de Herve"
          villages={["Herve","Battice","Thimister","Olne","Aubel"]}
          nearbyCities={["Herve","Battice","Thimister","Olne","Aubel","Plombières"]}
        />
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Prêt pour un nettoyage professionnel à <span className="text-yellow-300">Welkenraedt</span> ?
              </h2>
        ...
        <FeaturesSection cityName="Welkenraedt" />

        {/* Spacing between FeaturesSection and NearbyCities */}
        <div className="mb-8"></div>

        {/* Villes voisines Section */}
        <NearbyCities currentCity="Welkenraedt" nearbyCities={nearbyCities} />
