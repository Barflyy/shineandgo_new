        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 dark:text-white mb-6">
              Expert en lavage voiture à <span className="font-semibold">Olne</span>
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  Olne et ses alentours offrent un cadre magnifique mais parfois salissant pour les voitures (boue, poussière). Shine&Go se déplace dans ce cadre rural pour un nettoyage minutieux.
                </p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                  Nous portons une attention particulière aux intérieurs, souvent sollicités par la vie active et familiale à la campagne.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white">Zone Olne</h3>
