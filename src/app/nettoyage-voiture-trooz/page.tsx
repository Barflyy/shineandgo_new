        ...
        <div className="container mx-auto px-6 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-gray-900 mb-6 tracking-tight leading-[1.1] animate-fade-in-up text-balance" style={{ animationDelay: '0.2s' }}>
              Car Wash Mobile
              <span className="block font-semibold mt-2 text-gray-900">à Trooz</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 font-light leading-relaxed px-4 animate-fade-in-up text-pretty max-w-2xl mx-auto" style={{ animationDelay: '0.3s' }}>
              Shine&Go : le lavage auto qui se déplace jusqu'à Trooz.
              <span className="block mt-2 text-base text-gray-400 font-normal">Zéro déplacement • Service complet • Professionnel</span>
            </p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                ...
                { name: 'Fraipont', href: '/nettoyage-voiture-trooz' },
                { name: 'Nessonvaux', href: '/nettoyage-voiture-trooz' },
                { name: 'Olne', href: '/nettoyage-voiture-olne' },
                { name: 'Sprimont', href: '/nettoyage-voiture-sprimont' },
              ].map((city) => (
                <Link
                  key={city.name}
                  href={city.href}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-light text-gray-900 mb-4 sm:mb-6 leading-tight">
              Trooz,
              <span className="block">redonnez vie à votre auto</span>
            </h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Nettoyage Voiture à Domicile Trooz",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Shine&Go",
            ...
            "description": "Service de nettoyage automobile à domicile à Trooz. Lavage intérieur et extérieur, detailing, protection céramique.",
            "offers": {
              "@type": "Offer",
              "price": "65",
              "priceCurrency": "EUR"
