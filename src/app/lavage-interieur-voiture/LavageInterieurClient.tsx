...
function HeroSection() {
    const handleBooking = () => {
        window.open('https://wa.me/32472303701?text=Bonjour Nathan ! Je souhaite réserver un lavage intérieur. 🚗', '_blank');
    };
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg sm:text-xl text-slate-600 max-w-xl mx-auto leading-relaxed">
                            Nettoyage complet de l'habitacle : aspiration, plastiques, vitres, désodorisation. On vient chez vous près de <strong className="text-slate-900">Herve</strong> et alentours.
                    ...
                    >
                        {[
                            ...
                            { icon: Droplets, text: 'Produits Koch-Chemie' },
...
function BenefitsSection() {
    const benefits = [
        {
            icon: Armchair,
            title: "Habitacle comme neuf",
            description: "Aspiration complète, nettoyage plastiques, vitres, désodorisation.",
            color: "sky"
        },
        {
            icon: Droplets,
            ...
            <div className="max-w-6xl mx-auto px-5">
                ...
                >
                    ...
                    <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-3">
                        Votre intérieur comme neuf
                    </h2>
                    <p className="text-slate-600 max-w-md mx-auto">
                        Nettoyage complet et professionnel de l'habitacle.
                    </p>
                </motion.div>
    ...
    const testimonials = [
        {
            name: 'Sophie M.',
            location: 'Liège',
            text: 'Intérieur impeccable ! L\'odeur de propre est incroyable. Ma voiture sent le neuf.',
            avatar: '👩',
        },
        {
            name: 'Marc D.',
            location: 'Verviers',
            text: 'Très professionnel. Ma voiture n\'avait pas été aussi propre depuis des années. Les plastiques brillent !',
            avatar: '👨',
        },
        {
            name: 'Julie K.',
            location: 'Herve',
            text: 'Service pratique et résultat top. On voit que c\'est du travail soigné. Je recommande !',
            avatar: '👩‍🦰',
        },
    ];
            ...
            <div className="max-w-6xl mx-auto px-5">
                ...
                >
                    ...
                    <p className="text-slate-600">
                        Ce que nos clients disent de notre lavage intérieur
                    </p>
                </motion.div>
...
function FAQSection() {
    const faqs = [
        {
            question: "Combien coûte un nettoyage intérieur voiture à domicile ?",
            answer: "Nos tarifs démarrent à 80€ pour un nettoyage intérieur complet. Un supplément s'applique selon la taille du véhicule (SUV +20€, 7 places +30€)."
        },
        {
            question: "Que comprend le nettoyage intérieur ?",
            answer: "Aspiration complète (tapis, moquettes, sièges, coffre), nettoyage des plastiques et tableau de bord, vitres intérieures, tapis et moquettes si nécessaire, désodorisation et finitions au pinceau."
        },
        {
            question: "Combien de temps dure l'intervention ?",
            answer: "Un nettoyage intérieur complet dure environ 90 minutes selon l'état du véhicule. Nous prenons le temps nécessaire pour un résultat parfait."
        },
        {
            question: "Avez-vous besoin d'eau ou d'électricité ?",
            answer: "Idéalement oui, une prise électrique pour l'aspirateur. Si ce n'est pas possible, prévenez-nous à la réservation, nous avons des solutions autonomes."
        }
    ];
...
// MAIN PAGE
// ============================================
export default function LavageInterieurClient() {
    return (
