...
export const metadata: Metadata = {
  title: 'Lavage Voiture Intérieur à Domicile | Tapis & Plastiques - Shine&Go',
  description: 'Lavage voiture intérieur à domicile. Spécialiste nettoyage tapis, plastiques, désinfection habitacle. Élimination taches et odeurs. Dès 65€ à Liège & Verviers.',
  alternates: {
    canonical: 'https://shineandgo.be/lavage-interieur-voiture',
  },
  openGraph: {
    title: 'Lavage Voiture Intérieur à Domicile | Shine&Go',
    description: 'Lavage voiture intérieur professionnel à domicile. Nettoyage tapis, plastiques, désinfection. Dès 65€.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lavage voiture intérieur domicile - Shine&Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
...
export default function NettoyageInterieurPage() {
  const serviceSchema = {
    ...
    "@type": "Service",
    "serviceType": "Lavage Voiture Intérieur",
    "name": "Lavage Intérieur Voiture à Domicile",
    "description": "Nettoyage complet de l'habitacle : tapis, moquettes, sièges, plastiques, vitres intérieures. Aspiration profonde et désinfection.",
    "provider": {
      "@type": "LocalBusiness",
      "name": "Shine&Go",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify([
              ...
              },
              {
                ...
                "item": "https://shineandgo.be/lavage-interieur-voiture"
              }
            ])
          }}
        />
