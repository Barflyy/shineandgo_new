...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description: "Lavage et nettoyage voiture à domicile à Sprimont. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-sprimont.jpg",
          width: 1200,
          height: 630,
          alt: "nettoyage voiture domicile Sprimont",
        },
      ],
      locale: 'fr_BE',
      type: 'website',
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Sprimont | Shine&Go (service premium)",
      description: "Lavage et nettoyage voiture à domicile à Sprimont. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://www.shineandgo.be/images/avant-apres-nettoyage-voiture-sprimont.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function SprimontPage() {
  ...
  const structuredData = generateCityStructuredData('sprimont', 'Sprimont', {
    ...
    imageDescription: "Nettoyage voiture à domicile à Sprimont",
    breadcrumb: {
      l1: { name: "Accueil", url: "https://www.shineandgo.be/" },
      l2: { name: "Nettoyage voiture", url: "https://www.shineandgo.be/#services" },
      l3: { name: "Nettoyage voiture à Sprimont", url: "https://www.shineandgo.be/nettoyage-voiture-sprimont" },
    },
    faqs: [
      {
        question: "Intervenez-vous réellement dans toute la commune de Sprimont ?",
  ...
  return (
    <>
      ...
      <CityPageTemplateNew 
        citySlug="sprimont" 
        cityName="Sprimont"
        csvData={getCSVCityData('nettoyage-voiture-sprimont')}
      />
    </>
  );
}
