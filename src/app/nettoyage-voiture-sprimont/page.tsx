...
export const generateMetadata = (): Metadata => {
  return {
    ...
    alternates: {
      canonical: "https://shineandgo.be/nettoyage-voiture-sprimont",
    },
    openGraph: {
      title: "Nettoyage voiture à domicile à Sprimont | Shine&Go (service premium)",
      description: "Lavage et nettoyage voiture à domicile à Sprimont. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: [
        {
          url: "https://shineandgo.be/images/avant-apres-nettoyage-voiture-sprimont.jpg",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: "Nettoyage voiture à domicile à Sprimont | Shine&Go (service premium)",
      description: "Lavage et nettoyage voiture à domicile à Sprimont. Service complet intérieur/extérieur, produits premium, résultat showroom. Devis gratuit.",
      images: ["https://shineandgo.be/images/avant-apres-nettoyage-voiture-sprimont.jpg"],
    },
    other: {
      'geo.latitude': "",
      'geo.longitude': "",
...
export default function SprimontPage() {
  ...
  const structuredData = generateCityStructuredData('sprimont', 'Sprimont', {
    ...
    breadcrumb: {
      ...
      l3: { name: "Nettoyage voiture à Sprimont", url: "https://shineandgo.be/nettoyage-voiture-sprimont" },
    },
    faqs: [
      {
