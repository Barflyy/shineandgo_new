...
export const metadata: Metadata = {
  title: 'Lavage Voiture Visé à Domicile - Intérieur & Extérieur | Shine&Go',
  description: 'Lavage voiture à domicile à Visé. Service de lavage auto professionnel, nettoyage véhicule intérieur/extérieur. Prix clairs dès 65€. Déplacement gratuit. ☎ 0472 30 37 01',
  alternates: {
    canonical: 'https://shineandgo.be/lavage-voiture-vise',
  },
  openGraph: {
    title: 'Lavage Voiture Visé à Domicile - Intérieur & Extérieur | Shine&Go',
    description: 'Lavage voiture à domicile à Visé. Service de lavage auto professionnel, nettoyage véhicule intérieur/extérieur. Prix clairs dès 65€. Déplacement gratuit. ☎ 0472 30 37 01',
    url: 'https://shineandgo.be/lavage-voiture-vise',
    siteName: 'Shine&Go',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Lavage voiture domicile Visé - Shine&Go',
      },
    ],
    locale: 'fr_BE',
    type: 'website',
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-light text-gray-900 dark:text-white mb-8 text-center">
              Lavage auto dans la Cité de l'Oie
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                  Visé est une ville élégante. Nous aidons les Visétois à garder leurs véhicules dans un état irréprochable. Du centre-ville aux quartiers périphériques, nous sommes présents.
                </p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
                  Parfait pour préparer votre voiture avant une sortie ou simplement pour le plaisir de rouler dans le propre.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white">Zone Vise</h3>
